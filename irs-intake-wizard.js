...
const Select = ({ value, onChange, options, children }) => /* @__PURE__ */ React.createElement(
  "select",
  {
    value: value || "",
    onChange: (e) => onChange(e.target.value),
  ...
  children || options && options.map((o) => /* @__PURE__ */ React.createElement("option", { key: o.value, value: o.value }, o.label))
);
...
function StepAssets({ data, set }) {
  ...
  return /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement(SectionTitle, { sub: "Include all assets \u2014 domestic and foreign" }, "Personal Asset Information"), /* @__PURE__ */ React.createElement(InfoBox, { type: "info" }, "List all accounts and assets, even if the balance is zero. The IRS will verify this information against financial records."), /* @__PURE__ */ React.createElement("div", { style: { marginBottom: 24 } }, /* @__PURE__ */ React.createElement("div", { style: { fontWeight: 700, fontSize: 15, marginBottom: 12, color: "#1a1a2e" } }, "\uD83D\uDCB3 Bank Accounts"), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 12, color: "#7f8c8d", marginBottom: 10 } }, "Include checking, savings, online accounts, money market, PayPal, stored value cards, etc."), (data.bankAccounts || []).map((acct, i) => /* @__PURE__ */ React.createElement(Card, { key: i }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", justifyContent: "space-between", marginBottom: 10 } }, /* @__PURE__ */ React.createElement("strong", { style: { fontSize: 13 } }, "Account ", i + 1), /* @__PURE__ */ React.createElement(RemoveButton, { onClick: () => removeItem("bankAccounts", i) })), /* @__PURE__ */ React.createElement(Row2, null, /* @__PURE__ */ React.createElement(Field, { label: "Bank Name & Address" }, /* @__PURE__ */ React.createElement(Input, { value: acct.bankName, onChange: (v) => updateItem("bankAccounts", i, "bankName", v) })), /* @__PURE__ */ React.createElement(Field, { label: "Account Number" }, /* @__PURE__ */ React.createElement(Input, { value: acct.accountNumber, onChange: (v) => updateItem("bankAccounts", i, "accountNumber", v) }))), /* @__PURE__ */ React.createElement(Row2, null, /* @__PURE__ */ React.createElement(Field, { label: "Account Type" }, /* @__PURE__ */ React.createElement(
    Select,
    {
      value: acct.type,
...
function StepOIC({ data, set, allData }) {
  ...
  ].map((box) => /* @__PURE__ */ React.createElement("div", { key: box.label, style: { background: "rgba(200,169,110,0.1)", borderRadius: 8, padding: 12, border: "1px solid rgba(200,169,110,0.2)" } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 11, color: "#aaa", marginBottom: 4 } }, box.label), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 18, fontWeight: 800, color: "#c8a96e" } }, fmt(box.val))))), /* @__PURE__ */ React.createElement("div", { style: { display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12 } }, /* @__PURE__ */ React.createElement("div", { style: { background: "rgba(39,174,96,0.15)", borderRadius: 8, padding: 14, border: "1px solid rgba(39,174,96,0.3)" } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 12, color: "#aaa", marginBottom: 4 } }, "\uD83D\uDCB5 Minimum Offer \u2014 Cash (5 months)"), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 22, fontWeight: 800, color: "#27ae60" } }, fmt(r.minOfferCash))), /* @__PURE__ */ React.createElement("div", { style: { background: "rgba(200,169,110,0.1)", borderRadius: 8, padding: 14, border: "1px solid rgba(200,169,110,0.2)" } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 12, color: "#aaa", marginBottom: 4 } }, "\uD83D\uDCC5 Minimum Offer \u2014 Deferred (24 months)"), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 22, fontWeight: 800, color: "#c8a96e" } }, fmt(r.minOfferDeferred)))), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 12, color: "#7f8c8d", marginTop: 12 } }, "These figures are estimates. The IRS may calculate a different RCP based on their independent review of your assets and allowable expenses.")));
}
