...
function IRSIntakeWizard() {
  ...
  const STORAGE_KEY = "irs_navigator_intake";
  ...
  const handleImport = (e) => {
    ...
    reader.onload = (ev) => {
      try {
        ...
        alert("Could not read that file. Make sure it is an IRS Navigator save file.");
      }
    };
  ...
  return /* @__PURE__ */ React.createElement("div", { style: { fontFamily: "Georgia, serif", background: "#f8f6f1", minHeight: "100vh" } }, /* @__PURE__ */ React.createElement("div", { style: { background: "#1a1a2e", color: "#f8f6f1", padding: "16px 24px", borderBottom: "3px solid #c8a96e" } }, /* @__PURE__ */ React.createElement("div", { style: { maxWidth: 820, margin: "0 auto", display: "flex", justifyContent: "space-between", alignItems: "center" } }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 18, fontWeight: 800, color: "#c8a96e" } }, "IRS Financial Intake"), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 12, color: "#aaa" } }, "Form 433-A / 433-F / 433-B Auto-Fill System")), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", alignItems: "flex-end", gap: 8 } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 12, color: "#c8a96e", textAlign: "right" } }, "Step ", currentStep + 1, " of ", STEPS.length, " \xA0\xB7\xA0", /* @__PURE__ */ React.createElement("span", { style: { color: "#aaa" } }, step.label)), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 8, alignItems: "center" } }, saveStatus && /* @__PURE__ */ React.createElement("span", { style: { fontSize: 11, color: saveStatus === "cleared" ? "#f87171" : "#86efac", fontStyle: "italic" } }, saveStatus === "loaded" ? "\u2713 Progress restored" : saveStatus === "cleared" ? "\u2713 Cleared" : "\u2713 Saved"), /* @__PURE__ */ React.createElement(
    "button",
    {
      onClick: handleExport,
      style: { fontSize: 11, padding: "4px 10px", background: "transparent", color: "#c8a96e", border: "1px solid #c8a96e", borderRadius: 4, cursor: "pointer" }
    },
    "\u2B07 Save File"
  ), /* @__PURE__ */ React.createElement("label", { style: { fontSize: 11, padding: "4px 10px", background: "transparent", color: "#c8a96e", border: "1px solid #c8a96e", borderRadius: 4, cursor: "pointer" } }, "\u2B06 Load File", /* @__PURE__ */ React.createElement("input", { type: "file", accept: ".json", onChange: handleImport, style: { display: "none" } })), /* @__PURE__ */ React.createElement(
    "button",
    {
      onClick: handleClear,
    ...
    "\u2715 Clear"
  ))))), /* @__PURE__ */ React.createElement("div", { style: { background: "#1a1a2e", padding: "0 24px 16px" } }, /* @__PURE__ */ React.createElement("div", { style: { maxWidth: 820, margin: "0 auto" } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 4, marginBottom: 10 } }, STEPS.map((s, i) => /* @__PURE__ */ React.createElement("div", { key: s.id, style: {
    flex: 1,
    height: 4,
    borderRadius: 2,
    ...
    "div",
    {
      ...
      style: {
        fontSize: 12,
        color: i === currentStep ? "#c8a96e" : i < currentStep ? "#a89060" : "#6b7280",
        textAlign: "center",
        flex: 1,
        cursor: "pointer",
        padding: "4px 2px",
      ...
      onMouseLeave: (e) => e.currentTarget.style.color = i === currentStep ? "#c8a96e" : i < currentStep ? "#a89060" : "#6b7280"
    },
  ...
  } })), /* @__PURE__ */ React.createElement("div", { style: { position: "absolute", top: 0, left: 0, right: 0, bottom: 0, display: "flex", alignItems: "center", justifyContent: "center" } }, /* @__PURE__ */ React.createElement("div", { style: { background: "#fff", border: "2px solid #c8a96e", borderRadius: 16, padding: "36px 32px", maxWidth: 420, textAlign: "center", boxShadow: "0 8px 32px rgba(0,0,0,0.15)" } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 40, marginBottom: 12 } }, "\u{1F512}"), /* @__PURE__ */ React.createElement("div", { style: { fontWeight: "bold", fontSize: 18, color: "#1a1a2e", marginBottom: 8 } }, "Full Access Required"), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 14, color: "#666", lineHeight: 1.7, marginBottom: 24 } }, "You've completed the free preview (Step 1 \u2014 Personal Info).", /* @__PURE__ */ React.createElement("br", null), "Purchase access to continue with all 9 steps and auto-fill your IRS forms."), /* @__PURE__ */ React.createElement("a", { href: "/pricing", style: { display: "inline-block", padding: "12px 24px", background: "#1a1a2e", color: "#c8a96e", border: "2px solid #c8a96e", borderRadius: 8, fontFamily: "Georgia, serif", fontWeight: "bold", fontSize: 15, textDecoration: "none", marginBottom: 12 } }, "View Pricing \u2192"), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 12, color: "#aaa" } }, "Already purchased? ", /* @__PURE__ */ React.createElement("a", { href: "/login", style: { color: "#1a1a2e" } }, "Sign in \u2192"))))), (hasAccess || currentStep === 0) && step.id === "personal" && /* @__PURE__ */ React.createElement(StepPersonal, { data: formData.personal, set: setSection("personal") }), hasAccess && step.id === "business" && /* @__PURE__ */ React.createElement(StepBusiness, { data: formData.business, set: setSection("business") }), hasAccess && step.id === "employment" && /* @__PURE__ */ React.createElement(StepEmployment, { data: formData.employment, set: setSection("employment"), bizData: formData.business, personalData: formData.personal }), hasAccess && step.id === "otherinfo" && /* @__PURE__ */ React.createElement(StepOtherInfo, { data: formData.otherinfo, set: setSection("otherinfo") }), hasAccess && step.id === "assets" && /* @__PURE__ */ React.createElement(StepAssets, { data: formData.assets, set: setSection("assets") }), hasAccess && step.id === "income" && /* @__PURE__ */ React.createElement(StepIncome, { data: formData.income, set: setSection("income"), bizData: formData.business, empData: formData.employment }), hasAccess && step.id === "expenses" && /* @__PURE__ */ React.createElement(StepExpenses, { data: formData.expenses, set: setSection("expenses"), personalData: formData.personal }), hasAccess && step.id === "oic" && /* @__PURE__ */ React.createElement(StepOIC, { data: formData.oic, set: setSection("oic"), allData: formData }), hasAccess && step.id === "results" && /* @__PURE__ */ React.createElement(StepResults, { allData: formData, onDownload: handleDownload, downloading }), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", justifyContent: "space-between", marginTop: 32, paddingTop: 20, borderTop: "1px solid #e9ecef" } }, /* @__PURE__ */ React.createElement(
    "button",
    {
