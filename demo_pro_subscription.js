    ...
    menu === "branding" && React.createElement("div", null,
      React.createElement("div", { style: s.card },
        ...
        React.createElement("div", { style:{ display:"grid", gridTemplateColumns:"1fr 1fr", gap:12 } },
          [["Firm Name", FIRM.name], ["Credential", FIRM.credential], ["Phone", FIRM.phone], ["Scheduling Link", FIRM.calendly]].map(function(item, i) {
      ...
      React.createElement("div", { style:{ ...s.card, background:"#f0fdf4", border:"1px solid #7ec11f" } },
        ...
        ["Your firm name on every screen", "Your phone number with tap-to-call", "Your meeting scheduling link on every CTA button", "No IRS Pilot or Tyrone Taylor branding anywhere"].map(function(item, i) {
