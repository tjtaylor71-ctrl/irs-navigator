  ...
  const plans = [
    ...
    },
    {
      ...
      features: [
        ...
        "20+ interactive strategies with calculators",
    ...
    },
    {
      id: "covid_penalty",
      icon: "\uD83D\uDEE1\uFE0F",
      name: "COVID Penalty Relief Tool",
      price: 99,
      period: "7-day access",
      color: "#7f1d1d",
      accent: "#dc2626",
      badge: "NEW",
      description: "Identify and challenge IRS penalties assessed during COVID \u2014 under IRC \u00a76751(b) and Notice 2022-36.",
      features: [
        "Upload your IRS Account Transcript for instant analysis",
        "Identifies failure-to-file & failure-to-pay penalties in COVID window",
        "IRC \u00a76751(b) supervisory approval argument (Kwong, Abdo)",
        "IRS Notice 2022-36 automatic waiver analysis (2019 & 2020)",
        "Calculates total penalty amount at issue",
        "Generates ready-to-mail letter to IRS Penalty Abatement Coordinator"
      ],
      cta: "Get COVID Penalty Relief Tool",
      note: "Best for: Taxpayers who received IRS penalty notices for 2019\u20132022 and believe the penalties were improperly assessed."
    }
  ];
  return /* @__PURE__ */ React.createElement("div", { style: { fontFamily: "'DM Sans',sans-serif", background: "#f8f6f1", minHeight: "100vh", color: "#1a2d5a" } }, /* @__PURE__ */ React.createElement(IRSPilotNav, { subtitle: "TAXPAYER SELF-HELP" }), /* @__PURE__ */ React.createElement("div", { style: { maxWidth: 960, margin: "0 auto", padding: "48px 24px" } }, /* @__PURE__ */ React.createElement("div", { style: { textAlign: "center", marginBottom: 48 } }, /* @__PURE__ */ React.createElement("div", { style: { display: "inline-block", background: "#dc2626", color: "#fff", fontSize: 11, fontWeight: "bold", letterSpacing: 1.5, padding: "4px 14px", borderRadius: 20, marginBottom: 16 } }, "\u26A0 IRS DEADLINES DON'T WAIT \u2014 7-DAY ACCESS, ACT NOW"), /* @__PURE__ */ React.createElement("h1", { style: { fontSize: 36, fontWeight: "bold", margin: "0 0 12px", lineHeight: 1.2 } }, "Professional IRS Guidance.", /* @__PURE__ */ React.createElement("br", null), /* @__PURE__ */ React.createElement("span", { style: { color: "#7ec11f" } }, "Without the Professional Price Tag.")), /* @__PURE__ */ React.createElement("p", { style: { fontSize: 17, color: "#555", maxWidth: 580, margin: "0 auto", lineHeight: 1.7 } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", justifyContent: "center", gap: 14, flexWrap: "wrap", marginBottom: 8 } },
              /* @__PURE__ */ React.createElement("img", { src: "/static/tj_headshot.jpg", alt: "Tyrone J. Taylor, EA", onError: function(e){ e.target.style.display="none"; }, style: { width: 52, height: 52, borderRadius: "50%", objectFit: "cover", border: "2px solid #7ec11f", flexShrink: 0 } }),
              /* @__PURE__ */ React.createElement("span", null, "Built by ", /* @__PURE__ */ React.createElement("strong", null, "Tyrone J. Taylor, EA"), " \u2014 a federally licensed Enrolled Agent and author of ", /* @__PURE__ */ React.createElement("em", null, "Stop IRS Collections"), ". Get the same guidance his clients pay for, at a fraction of the cost.")
            ),
            /* @__PURE__ */ React.createElement("p", { style: { fontSize: 13, color: "#888", marginTop: 8, fontStyle: "italic" } }, "$59\u2013$129 one-time \u2014 a fraction of a $2,000\u2013$10,000 EA or attorney retainer for self-serve situations."))), /* @__PURE__ */ React.createElement("div", { style: { display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: 20, marginBottom: 40, alignItems: "start" } }, plans.map((plan) => /* @__PURE__ */ React.createElement(
    "div",
    {
      key: plan.id,
      ...
      style: {
        background: "#fff",
        borderRadius: 16,
        border: plan.id === "wizard" ? `2px solid #1a2d5a` : `2px solid ${hoveredPlan === plan.id ? plan.accent : "#e8e4dc"}`,
        boxShadow: plan.id === "wizard" ? "0 8px 32px rgba(26,45,90,0.18)" : undefined,
        transform: plan.id === "wizard" ? "scale(1.035)" : undefined,
        position: plan.id === "wizard" ? "relative" : undefined,
        zIndex: plan.id === "wizard" ? 2 : undefined,
        overflow: "hidden",
        transition: "all 0.2s",
    ...
    /* @__PURE__ */ React.createElement("div", { style: { textAlign: "center", fontSize: 12, color: "#aaa", padding: "8px 0 0" } }, "\uD83D\uDD12 Secured by Stripe \u00b7 No data sold \u00b7 24-hr refund")
