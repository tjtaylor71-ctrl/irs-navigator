  ...
  const toolBtn = (href, icon, label, sub, active) => React.createElement(
    "a",
    {
      ...
      style: {
        ...
        borderRadius: 10,
        textDecoration: "none",
        border: `2px solid ${active ? "#c8a96e" : "#e8e4dc"}`,
        background: active ? "#1a1a2e" : "#f8f6f1",
    ...
    React.createElement(
      "div",
      { style: { flex: 1 } },
      React.createElement("div", { style: { fontWeight: "bold", fontSize: 15, color: active ? "#c8a96e" : "#999" } }, label),
      React.createElement("div", { style: { fontSize: 12, color: active ? "#aaa" : "#bbb", marginTop: 2 } }, sub)
    ),
    React.createElement(
      "div",
      { style: { fontSize: 13, color: active ? "#c8a96e" : "#ccc" } },
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement("div", { style: { width: 36, height: 36, background: "#c8a96e", borderRadius: 8, display: "flex", alignItems: "center", justifyContent: "center", fontSize: 18 } }, "\u2696\uFE0F"),
          React.createElement(
            "div",
            null,
            React.createElement("div", { style: { color: "#fff", fontWeight: "bold", fontSize: 16 } }, "IRS Navigator"),
            React.createElement("div", { style: { color: "#c8a96e", fontSize: 11, letterSpacing: 1 } }, "TAXPAYER SELF-HELP")
          )
        ),
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        React.createElement("div", { style: { fontSize: 22, fontWeight: "bold", color: "#1a1a2e", marginBottom: 4 } }, "My Account"),
      ...
      React.createElement(
        "div",
        { style: card },
        React.createElement("div", { style: { fontWeight: "bold", fontSize: 16, marginBottom: 16, color: "#1a1a2e" } }, "Your Tools"),
        ...
        (!hasNavigator || !hasWizard) && React.createElement(
          ...
          "Need access? ",
          React.createElement("a", { href: "/pricing", style: { color: "#1a1a2e", fontWeight: "bold" } }, "View pricing \u2192")
        )
      ),
      // Consultation card
      React.createElement(
        "div",
        { style: { ...card, background: "#1a1a2e", border: "none" } },
        React.createElement("div", { style: { fontWeight: "bold", fontSize: 15, color: "#c8a96e", marginBottom: 8 } }, "Need Professional Help?"),
        React.createElement(
          "div",
          { style: { fontSize: 14, color: "#aaa", marginBottom: 18, lineHeight: 1.6 } },
          "Schedule a free 15-minute consultation with Tyrone J. Taylor, EA \u2014 author of Stop IRS Collections."
        ),
        React.createElement("a", {
          href: "https://www.calendly.com/taylor-tax-financial/tax-help",
          target: "_blank",
          rel: "noopener noreferrer",
          style: { display: "inline-flex", alignItems: "center", gap: 8, padding: "11px 22px", background: "#c8a96e", color: "#1a1a2e", borderRadius: 8, fontWeight: "bold", fontSize: 14, textDecoration: "none" }
