...
function LetterGenerator() {
  ...
  const generateLetter = async () => {
    ...
    const prompt = `You are a professional IRS representative writing on behalf of a taxpayer. 
Write a formal, professional letter to the IRS based on the following information.

Letter Type: ${typeDef?.label}
Taxpayer Information:
${Object.entries(formData).map(([k, v]) => `${FIELD_LABELS[k] || k}: ${v}`).join("\n")}

Instructions:
- Use formal letter format with today's date, taxpayer address, IRS address block, RE: line, salutation, body paragraphs, and closing
- Be concise, factual, and professional
- Cite relevant IRC sections or IRM procedures where appropriate
- Include a clear specific request or proposed action
- Do not include legal advice disclaimers
- Today's date: ${(/* @__PURE__ */ new Date()).toLocaleDateString("en-US", { year: "numeric", month: "long", day: "numeric" })}
- IRS address should be generic: "Internal Revenue Service, [Appropriate Campus]"
- Sign off as the taxpayer`;
    try {
  ...
  return /* @__PURE__ */ React.createElement("div", { style: { fontFamily: "Georgia, serif", background: "#f8f6f1", minHeight: "100vh" } }, /* @__PURE__ */ React.createElement("div", { style: { background: "#1a1a2e", padding: "16px 24px", borderBottom: "3px solid #c8a96e" } }, /* @__PURE__ */ React.createElement("div", { style: { maxWidth: 820, margin: "0 auto", display: "flex", justifyContent: "space-between", alignItems: "center" } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 12 } }, /* @__PURE__ */ React.createElement("div", { style: { width: 36, height: 36, background: "#c8a96e", borderRadius: 8, display: "flex", alignItems: "center", justifyContent: "center", fontSize: 18 } }, "\u2696\uFE0F"), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { style: { color: "#fff", fontWeight: "bold", fontSize: 16 } }, "IRS Response Letter Generator"), /* @__PURE__ */ React.createElement("div", { style: { color: "#c8a96e", fontSize: 11, letterSpacing: 1 } }, "PROFESSIONAL CORRESPONDENCE"))), /* @__PURE__ */ React.createElement("a", { href: "/navigator", style: { color: "#aaa", fontSize: 13, textDecoration: "none", border: "1px solid #444", padding: "6px 14px", borderRadius: 6 } }, "\u2190 Navigator"))), /* @__PURE__ */ React.createElement("div", { style: { maxWidth: 820, margin: "0 auto", padding: "32px 24px" } }, mode === "choose" && /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("div", { style: { marginBottom: 28 } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 22, fontWeight: "bold", marginBottom: 6 } }, "What kind of letter do you need?"), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 14, color: "#666" } }, "Select the letter type and we'll guide you through the information needed.")), /* @__PURE__ */ React.createElement("div", { style: card }, /* @__PURE__ */ React.createElement("div", { style: { fontWeight: "bold", fontSize: 15, marginBottom: 14, color: "#1a1a2e" } }, "\u{1F4EC} Responding to a Notice"), /* @__PURE__ */ React.createElement("div", { style: { display: "grid", gap: 10 } }, NOTICE_LETTERS.map((l) => /* @__PURE__ */ React.createElement(
    "div",
    {
      key: l.id,
      onClick: () => {
    ...
    /* @__PURE__ */ React.createElement("div", { style: { fontWeight: "bold", fontSize: 14, color: "#1a1a2e" } }, l.label),
    /* @__PURE__ */ React.createElement("div", { style: { fontSize: 12, color: "#888", marginTop: 3 } }, l.desc)
  )))), /* @__PURE__ */ React.createElement("div", { style: card }, /* @__PURE__ */ React.createElement("div", { style: { fontWeight: "bold", fontSize: 15, marginBottom: 14, color: "#1a1a2e" } }, "\u{1F6E1}\uFE0F Resolution Requests"), /* @__PURE__ */ React.createElement("div", { style: { display: "grid", gap: 10 } }, RESOLUTION_LETTERS.map((l) => /* @__PURE__ */ React.createElement(
    "div",
    {
      key: l.id,
      onClick: () => {
    ...
    return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 12, marginBottom: 24 } }, /* @__PURE__ */ React.createElement("button", { onClick: () => setMode("choose"), style: { background: "transparent", border: "none", color: "#888", fontSize: 22, cursor: "pointer", padding: 0 } }, "\u2190"), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 20, fontWeight: "bold" } }, typeDef?.label), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 13, color: "#888" } }, "Fill in the fields below to generate your letter"))), /* @__PURE__ */ React.createElement("div", { style: card }, /* @__PURE__ */ React.createElement("div", { style: { display: "grid", gap: 16 } }, fields.map((f) => /* @__PURE__ */ React.createElement("div", { key: f }, /* @__PURE__ */ React.createElement("label", { style: { fontWeight: "bold", fontSize: 13, display: "block", marginBottom: 6, color: "#1a1a2e" } }, FIELD_LABELS[f] || f), TEXTAREA_FIELDS.includes(f) ? /* @__PURE__ */ React.createElement(
      ...
      "button",
      {
        ...
        disabled: loading,
        style: { width: "100%", padding: "14px", background: "#1a1a2e", color: "#c8a96e", border: "2px solid #c8a96e", borderRadius: 8, fontSize: 15, fontWeight: "bold", fontFamily: "Georgia, serif", cursor: loading ? "not-allowed" : "pointer", opacity: loading ? 0.7 : 1 }
      },
    ...
    "button",
    {
      ...
      style: { padding: "8px 16px", background: "transparent", border: "1px solid #c8a96e", color: "#1a1a2e", borderRadius: 7, fontSize: 13, cursor: "pointer", fontFamily: "Georgia, serif" }
    },
    "\u{1F4CB} Copy"
  ), /* @__PURE__ */ React.createElement(
    "button",
    {
      onClick: printLetter,
      style: { padding: "8px 16px", background: "#1a1a2e", color: "#c8a96e", border: "2px solid #c8a96e", borderRadius: 7, fontSize: 13, cursor: "pointer", fontFamily: "Georgia, serif", fontWeight: "bold" }
    },
    "\u{1F5A8}\uFE0F Print"
  ), /* @__PURE__ */ React.createElement(
    "button",
    ...
    "New Letter"
  ))), /* @__PURE__ */ React.createElement("div", { style: { background: "#fff", borderRadius: 12, border: "1px solid #e8e4dc", padding: "40px 44px", whiteSpace: "pre-wrap", fontFamily: "Times New Roman, serif", fontSize: 13, lineHeight: 1.8, color: "#1a1a2e" } }, letter), /* @__PURE__ */ React.createElement("div", { style: { marginTop: 16, padding: "14px 18px", background: "#fef9ec", border: "1px solid #fde68a", borderRadius: 10, fontSize: 13, color: "#92400e" } }, "\u26A0 Review this letter carefully before sending. Verify all dates, amounts, and IRS addresses are accurate. Consider having a tax professional review any letter before submission."))));
}
