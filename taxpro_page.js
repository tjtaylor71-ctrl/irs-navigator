...
function ProApplicationForm() {
  var _sub = useSt(false); var submitted = _sub[0]; var setSubmitted = _sub[1];
  var _saving = useSt(false); var saving = _saving[0]; var setSaving = _saving[1];
  var _err = useSt(""); var error = _err[0]; var setError = _err[1];
  var _f = useSt({ name:"", email:"", firm:"", address:"", phone:"", website:"", calendly:false });
  var form = _f[0]; var setForm = _f[1];

  function set(key, val) { setForm(function(prev){ var n=Object.assign({},prev); n[key]=val; return n; }); }

  function handleSubmit() {
    if (!form.name.trim() || !form.email.trim() || !form.firm.trim() || !form.phone.trim()) {
      setError("Name, email, firm name, and phone number are required."); return;
    }
    ...
    fetch("/api/pro/apply", {
      ...
      body: JSON.stringify({
        name: form.name, email: form.email, firm: form.firm,
        address: form.address, phone: form.phone, website: form.website,
        calendly_requested: form.calendly
      })
    })
    .then(function(r){ return r.json(); })
    .then(function(d){
  ...
  var inp = { width:"100%", border:"1px solid #e8e4dc", borderRadius:8, padding:"10px 12px", fontSize:14, fontFamily:"'DM Sans',sans-serif", boxSizing:"border-box" };
  var lbl = { display:"block", fontSize:12, fontWeight:"bold", color:"#1a2d5a", marginBottom:4, textTransform:"uppercase", letterSpacing:0.4 };

  return React.createElement("div", { id:"pro-apply-form", style:{ background:"#fff", borderRadius:14, border:"2px solid #1a2d5a", padding:"32px", marginBottom:32 } },
    React.createElement("div", { style:{ textAlign:"center", marginBottom:24 } },
      React.createElement("div", { style:{ display:"inline-block", background:"#1a2d5a", color:"#7ec11f", fontSize:11, fontWeight:"bold", letterSpacing:1.5, padding:"4px 14px", borderRadius:20, marginBottom:12 } }, "PRO SUBSCRIPTION APPLICATION"),
      React.createElement("h2", { style:{ fontSize:22, fontWeight:"bold", color:"#1a2d5a", marginBottom:8 } }, "Apply for the Pro Subscription"),
      React.createElement("p", { style:{ color:"#666", fontSize:14, maxWidth:480, margin:"0 auto" } }, "Complete the form below. Tyrone Taylor will review your application and follow up within 1\u20132 business days. Upon approval, you will receive the Partner Guide and a W-9 by email.")
    ),
    submitted ? React.createElement("div", { style:{ textAlign:"center", padding:"24px 0" } },
      React.createElement("div", { style:{ fontSize:44, marginBottom:12 } }, "\u2705"),
      React.createElement("div", { style:{ fontSize:18, fontWeight:"bold", color:"#1a2d5a", marginBottom:8 } }, "Application Received!"),
      React.createElement("div", { style:{ fontSize:14, color:"#666", lineHeight:1.7 } },
        "We\u2019ll review your application and follow up within 1\u20132 business days. Check your email at ",
        React.createElement("strong", null, form.email), "."
      ),
      form.calendly && React.createElement("div", { style:{ marginTop:16 } },
        React.createElement("a", { href:"https://calendly.com/taylor-tax-financial/tax-professionals", target:"_blank", style:{ background:"#1a2d5a", color:"#7ec11f", borderRadius:8, padding:"10px 22px", textDecoration:"none", fontWeight:"bold", fontSize:14 } }, "Schedule Your Zoom Call \u2192")
      )
    ) : React.createElement("div", null,
      React.createElement("div", { style:{ display:"grid", gridTemplateColumns:"repeat(auto-fit,minmax(220px,1fr))", gap:14, marginBottom:14 } },
        React.createElement("div", null,
          React.createElement("label", { style:lbl }, "Full Name *"),
          React.createElement("input", { style:inp, placeholder:"Jane Smith", value:form.name, onChange:function(e){set("name",e.target.value);} })
        ),
        React.createElement("div", null,
          React.createElement("label", { style:lbl }, "Email Address *"),
          React.createElement("input", { style:inp, type:"email", placeholder:"jane@smithtax.com", value:form.email, onChange:function(e){set("email",e.target.value);} })
        ),
        React.createElement("div", null,
          React.createElement("label", { style:lbl }, "Firm Name *"),
          React.createElement("input", { style:inp, placeholder:"Smith Tax Group, EA", value:form.firm, onChange:function(e){set("firm",e.target.value);} })
        ),
        React.createElement("div", null,
          React.createElement("label", { style:lbl }, "Phone Number *"),
          React.createElement("input", { style:inp, type:"tel", placeholder:"(312) 555-0187", value:form.phone, onChange:function(e){set("phone",e.target.value);} })
        ),
        React.createElement("div", { style:{ gridColumn:"1/-1" } },
          React.createElement("label", { style:lbl }, "Business Address"),
          React.createElement("input", { style:inp, placeholder:"123 Main St, Chicago, IL 60601", value:form.address, onChange:function(e){set("address",e.target.value);} })
        ),
        React.createElement("div", { style:{ gridColumn:"1/-1" } },
          React.createElement("label", { style:lbl }, "Website"),
          React.createElement("input", { style:inp, placeholder:"https://smithtaxgroup.com", value:form.website, onChange:function(e){set("website",e.target.value);} })
        )
      ),
      React.createElement("div", { style:{ background:"#f0f7ff", border:"1px solid #bcd4f0", borderRadius:8, padding:"14px 16px", marginBottom:16 } },
        React.createElement("div", { style:{ display:"flex", alignItems:"flex-start", gap:10 } },
          React.createElement("input", { type:"checkbox", id:"calendly-check", checked:form.calendly, onChange:function(e){set("calendly",e.target.checked);}, style:{ marginTop:3, cursor:"pointer", flexShrink:0 } }),
          React.createElement("label", { htmlFor:"calendly-check", style:{ fontSize:13, color:"#1a2d5a", lineHeight:1.65, cursor:"pointer" } },
            React.createElement("strong", null, "Schedule a Zoom with Tyrone Taylor"),
            " \u2014 I\u2019d like to set up a call to discuss the program before getting started. After submitting, I\u2019ll receive a Calendly link to book a time."
          )
        )
      ),
      error && React.createElement("div", { style:{ background:"#fef2f2", border:"1px solid #fca5a5", borderRadius:7, padding:"10px 14px", fontSize:13, color:"#dc2626", marginBottom:14 } }, error),
      React.createElement("button", {
        onClick:handleSubmit, disabled:saving,
        style:{ width:"100%", background:"#1a2d5a", color:"#7ec11f", border:"2px solid #7ec11f", borderRadius:8, padding:"13px", fontFamily:"'DM Sans',sans-serif", fontWeight:"bold", fontSize:15, cursor:"pointer" }
      }, saving ? "Submitting\u2026" : "Submit Application \u2192"),
      React.createElement("div", { style:{ fontSize:11, color:"#aaa", textAlign:"center", marginTop:8 } }, "Tyrone Taylor will review your application personally and follow up within 1\u20132 business days.")
    )
  );
}
...
function TaxProPage() {
  ...
  return /* @__PURE__ */ React.createElement("div", { style: { fontFamily: "'DM Sans',sans-serif", background: "#f8f6f1", minHeight: "100vh" } }, /* @__PURE__ */ React.createElement(IRSPilotNav, { subtitle: "TAX PROFESSIONALS" }), /* @__PURE__ */ React.createElement("div", { style: { background: "#1a2d5a", padding: "36px 16px 32px", textAlign: "center" } }, /* @__PURE__ */ React.createElement("div", { style: { display: "inline-block", background: "#7ec11f", color: "#1a2d5a", fontSize: 11, fontWeight: "bold", letterSpacing: 1.5, padding: "4px 14px", borderRadius: 20, marginBottom: 18 } }, "FOR TAX PROFESSIONALS"), /* @__PURE__ */ React.createElement("h1", { style: { fontSize: "clamp(24px, 5vw, 38px)", fontWeight: "bold", color: "#fff", margin: "0 0 14px", lineHeight: 1.2 } }, "Turn IRS Problems Into", /* @__PURE__ */ React.createElement("br", null), /* @__PURE__ */ React.createElement("span", { style: { color: "#7ec11f" } }, "Revenue Opportunities")), /* @__PURE__ */ React.createElement("p", { style: { fontSize: 15, color: "#aaa", maxWidth: 580, margin: "0 auto 24px", lineHeight: 1.7 } }, "Two programs designed for tax professionals \u2014 refer clients and earn commissions instantly, or offer IRS Pilot under your own brand with an approved pro subscription.")), /* @__PURE__ */ React.createElement("div", { style: { maxWidth: 900, margin: "0 auto", padding: "32px 16px" } }, /* @__PURE__ */ React.createElement("div", { style: { textAlign: "center", marginBottom: 24 } }, /* @__PURE__ */ React.createElement("h2", { style: { fontSize: 22, fontWeight: "bold", color: "#1a2d5a", marginBottom: 8 } }, "Choose Your Program"), /* @__PURE__ */ React.createElement("p", { style: { color: "#666", fontSize: 14 } }, "Or do both \u2014 many partners use them together.")), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 16, marginBottom: 40, flexWrap: "wrap" } }, /* @__PURE__ */ React.createElement("div", { style: { flex: "1 1 300px", minWidth: 0, background: "#fff", borderRadius: 14, border: "1px solid #e8e4dc", overflow: "hidden" } }, /* @__PURE__ */ React.createElement("div", { style: { background: "#1a2d5a", padding: "24px 24px 20px" } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 32, marginBottom: 8 } }, "\u{1F517}"), /* @__PURE__ */ React.createElement("div", { style: { color: "#fff", fontWeight: "bold", fontSize: 20, marginBottom: 4 } }, "Referral Program"), /* @__PURE__ */ React.createElement("div", { style: { color: "#7ec11f", fontSize: 13, marginBottom: 12 } }, "Free to join \xB7 No monthly fee \xB7 Enroll instantly"), /* @__PURE__ */ React.createElement("div", { style: { color: "#7ec11f", fontSize: 32, fontWeight: "bold" } }, "20%", /* @__PURE__ */ React.createElement("span", { style: { fontSize: 16, fontWeight: "normal" } }, " per sale"))), /* @__PURE__ */ React.createElement("div", { style: { padding: "20px 24px" } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 14, color: "#555", lineHeight: 1.7, marginBottom: 16 } }, "Share your unique referral link with clients who have IRS issues you're not handling directly. When they purchase, you earn 20% automatically \u2014 tracked in your dashboard. No approval needed. Enroll and get your link immediately."), /* @__PURE__ */ React.createElement("div", { style: { display: "grid", gap: 8, marginBottom: 20 } }, [
  ...
  ].map((f, i) => /* @__PURE__ */ React.createElement("div", { key: i, style: { display: "flex", gap: 8, fontSize: 13, color: "#333" } }, /* @__PURE__ */ React.createElement("span", { style: { color: "#7ec11f", fontWeight: "bold", flexShrink: 0 } }, "\u2713"), f))), /* @__PURE__ */ React.createElement("div", { style: { background: "#fff8e8", border: "1px solid #f59e0b", borderRadius: 8, padding: "10px 14px", marginBottom: 16, fontSize: 12, color: "#92400e", lineHeight: 1.6 } }, /* @__PURE__ */ React.createElement("strong", null, "\u23F3 Requires approval."), " Submit your information and we'll set you up within 1 business day."), /* @__PURE__ */ React.createElement("button", {
    onClick: function(){ document.getElementById("pro-apply-form").scrollIntoView({ behavior: "smooth" }); },
    style: { display: "block", width: "100%", textAlign: "center", padding: "12px", background: "#1a2d5a", color: "#7ec11f", border: "2px solid #7ec11f", borderRadius: 8, fontWeight: "bold", fontSize: 14, cursor: "pointer", fontFamily: "'DM Sans',sans-serif" }
  }, "\uD83D\uDCEC Apply for Pro Subscription \u2192"), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 11, color: "#aaa", textAlign: "center", marginTop: 8 } }, "Free to apply \u00b7 Approved within 1 business day")))), /* @__PURE__ */ React.createElement("div", { style: { background: "#fff", borderRadius: 14, border: "1px solid #e8e4dc", padding: "28px", marginBottom: 20 } }, /* @__PURE__ */ React.createElement("h2", { style: { fontSize: 18, fontWeight: "bold", color: "#1a2d5a", marginBottom: 16 } }, "\u{1F517} How the Referral Program Works"), /* @__PURE__ */ React.createElement("div", { style: { display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(150px, 1fr))", gap: 16 } }, [
    ...
    "button",
    {
      ...
      style: { width: "100%", padding: "13px", background: "#1a2d5a", color: "#7ec11f", border: "2px solid #7ec11f", borderRadius: 8, fontFamily: "'DM Sans',sans-serif", fontWeight: "bold", fontSize: 15, cursor: demoSubmitting ? "not-allowed" : "pointer", opacity: demoSubmitting ? 0.7 : 1 }
    },
