...
def generate_video():
    ...
    system_prompt = (
        ...
        '6. The script must reference the real source of the story - the named interview, publication, documentary, or person. '
