...
function ResetPage() {
  ...
  const btn = { width: "100%", padding: "13px", background: "#1a1a2e", color: "#c8a96e", border: "2px solid #c8a96e", borderRadius: 8, fontSize: 15, fontWeight: "bold", fontFamily: "Georgia, serif", cursor: status === "loading" ? "not-allowed" : "pointer", opacity: status === "loading" ? 0.7 : 1 };
