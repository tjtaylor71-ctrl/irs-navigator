    ...
    with get_db() as conn:
        conn.executescript("""
            ...
            CREATE TABLE IF NOT EXISTS bookkeeping_categories (
                ...
                created_by  INTEGER REFERENCES users(id),
                name        TEXT NOT NULL,
                qbo_account TEXT DEFAULT '',
                created_at  TEXT DEFAULT (datetime('now'))
            );
            CREATE UNIQUE INDEX IF NOT EXISTS idx_bk_cat_name
                ON bookkeeping_categories(created_by, name);
            ...
            CREATE INDEX IF NOT EXISTS idx_bk_rules_user
                ON bookkeeping_rules(created_by, match_type);
