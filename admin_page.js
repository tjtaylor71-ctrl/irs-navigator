...
function AdminPage() {
  ...
  const [editProSub, setEditProSub] = React.useState(null);
  const [editPartner, setEditPartner] = React.useState(null);
  ...
  const [proPayLink, setProPayLink] = React.useState("");
  ...
  const handleCreatePro = async () => {
    ...
    const res = await fetch("/api/admin/pro/create", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
      body: JSON.stringify({ email: proEmail, firm_name: proFirm, contact_name: proName, contact_phone: proPhone, calendly_url: proCal, payment_link: proPayLink })
    });
    const d = await res.json();
    if (res.ok) {
      let msg = `\u2705 ${d.message}`;
  ...
  if (loading) return /* @__PURE__ */ React.createElement("div", { style: { fontFamily: "'DM Sans',sans-serif", padding: 40, color: "#888" } }, "Loading admin data...");
  if (error) return /* @__PURE__ */ React.createElement("div", { style: { fontFamily: "'DM Sans',sans-serif", padding: 40, color: "#dc2626" } }, error);
  if (!data) return /* @__PURE__ */ React.createElement("div", { style: { fontFamily: "'DM Sans',sans-serif", padding: 40, color: "#888" } }, "No data available. Please refresh.");

  return /* @__PURE__ */ React.createElement("div", { style: { fontFamily: "'DM Sans',sans-serif", background: "#f8f6f1", minHeight: "100vh" } },
      ...
      /* @__PURE__ */ React.createElement("div", { style: { background: "#fff", borderRadius: 12, border: "1px solid #e8e4dc", padding: "24px", marginBottom: 20 } },
        ...
        /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 10, alignItems: "center", flexWrap: "wrap" } },
          ...
          /* @__PURE__ */ React.createElement("select", { value: grantProduct, onChange: (e) => setGrantProduct(e.target.value), style: { ...inp, background: "#fff", width: "auto" } },
            ...
            /* @__PURE__ */ React.createElement("option", { value: "planning" }, "Tax Planning ($99)")
          ),
          /* @__PURE__ */ React.createElement("button", { onClick: handleGrant, style: { padding: "9px 20px", background: "#1a2d5a", color: "#7ec11f", border: "2px solid #7ec11f", borderRadius: 7, fontFamily: "'DM Sans',sans-serif", fontWeight: "bold", fontSize: 14, cursor: "pointer" } }, "Grant \u2192")
        ),
                    ...
                    /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 6, flexWrap: "wrap" } },
                      (user.purchases || []).map((p) =>
                        /* @__PURE__ */ React.createElement(React.Fragment, { key: p.id },
                          /* @__PURE__ */ React.createElement("button", { onClick: () => handleRevoke(p.id, user.email), style: { padding: "4px 10px", background: "transparent", border: "1px solid #fecaca", color: "#dc2626", borderRadius: 5, fontSize: 12, cursor: "pointer", fontFamily: "'DM Sans',sans-serif" } }, "Revoke ", productLabel[p.product]),
                          ["wizard", "bundle"].includes(p.product) && /* @__PURE__ */ React.createElement("button", { onClick: () => handleUnlockWizard(user.email), style: { padding: "4px 10px", background: "transparent", border: "1px solid #bfdbfe", color: "#1e40af", borderRadius: 5, fontSize: 12, cursor: "pointer", fontFamily: "'DM Sans',sans-serif" } }, "\uD83D\uDD13 Unlock Wizard")
                        )
                      ),
                      /* @__PURE__ */ React.createElement("button", { onClick: async () => { const res = await fetch("/api/admin/users/list"); const d = await res.json(); const enriched = (d.users || []).find(function(u){ return u.id === user.id; }) || user; setEditUser(enriched); }, style: { padding: "4px 10px", background: "#f0f7ff", color: "#1a2d5a", border: "1px solid #1a2d5a", borderRadius: 5, fontSize: 11, cursor: "pointer", fontFamily: "'DM Sans',sans-serif", fontWeight: "bold", marginRight: 4 } }, "\u270F\uFE0F Edit"),
                      /* @__PURE__ */ React.createElement("button", {
                        onClick: async () => {
                        ...
                        style: { padding: "4px 10px", background: "transparent", border: "1px solid #fecaca", color: "#dc2626", borderRadius: 5, fontSize: 11, cursor: "pointer", fontFamily: "'DM Sans',sans-serif", marginTop: 4, display: "block" }
                      }, "\uD83D\uDDD1 Delete User")
                    )
                  )
                )
    ...
    tab === "discounts" && /* @__PURE__ */ React.createElement("div", { style: { maxWidth: 960, margin: "0 auto", padding: "0 24px 32px" } },
      /* @__PURE__ */ React.createElement("div", { style: { background: "#fff", borderRadius: 12, border: "1px solid #e8e4dc", padding: 24, marginBottom: 20 } },
        ...
        /* @__PURE__ */ React.createElement("div", { style: { display: "grid", gridTemplateColumns: "2fr 1fr 1fr 1fr auto", gap: 10, alignItems: "end" } },
          ...
          /* @__PURE__ */ React.createElement("button", { onClick: handleCreateDiscount, style: { padding: "9px 18px", background: "#1a2d5a", color: "#7ec11f", border: "2px solid #7ec11f", borderRadius: 7, fontFamily: "'DM Sans',sans-serif", fontWeight: "bold", cursor: "pointer", whiteSpace: "nowrap" } }, "Create \u2192")
        ),
          ...
          /* @__PURE__ */ React.createElement("tbody", null,
            ...
            discounts.map((d) =>
              /* @__PURE__ */ React.createElement("tr", { key: d.id, style: { borderTop: "1px solid #f0ede8" } },
                ...
                /* @__PURE__ */ React.createElement("td", { style: { padding: "12px 16px" } },
                  d.active && /* @__PURE__ */ React.createElement("button", { onClick: () => handleDeactivate(d.id), style: { padding: "4px 10px", background: "transparent", border: "1px solid #fecaca", color: "#dc2626", borderRadius: 5, fontSize: 12, cursor: "pointer", fontFamily: "'DM Sans',sans-serif" } }, "Deactivate"),
                  /* @__PURE__ */ React.createElement("button", { onClick: async () => { if (!confirm("Delete this discount code?")) return; await fetch("/api/admin/discount/delete", { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify({ id: d.id }) }); load(); }, style: { padding: "4px 10px", background: "transparent", border: "1px solid #fecaca", color: "#dc2626", borderRadius: 5, fontSize: 12, cursor: "pointer", fontFamily: "'DM Sans',sans-serif" } }, "\uD83D\uDDD1 Delete")
                )
              )
            )
          )
    ...
    tab === "referrals" && /* @__PURE__ */ React.createElement("div", { style: { maxWidth: 960, margin: "0 auto", padding: "0 24px 32px" } },
      /* @__PURE__ */ React.createElement("div", { style: { background: "#fff", borderRadius: 12, border: "1px solid #e8e4dc", padding: 24, marginBottom: 20 } },
        ...
        /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 10, flexWrap: "wrap" } },
          /* @__PURE__ */ React.createElement("input", { value: newRefEmail, onChange: (e) => setNewRefEmail(e.target.value), placeholder: "partner@email.com", style: { flex: 1, minWidth: 220, padding: "9px 12px", border: "1px solid #ddd", borderRadius: 8, fontSize: 14, fontFamily: "'DM Sans',sans-serif" } }),
          /* @__PURE__ */ React.createElement("button", { onClick: handleCreateReferral, style: { padding: "9px 20px", background: "#1a2d5a", color: "#7ec11f", border: "2px solid #7ec11f", borderRadius: 8, fontFamily: "'DM Sans',sans-serif", fontWeight: "bold", fontSize: 13, cursor: "pointer" } }, "Create Partner \u2192")
        ),
          ...
          /* @__PURE__ */ React.createElement("tbody", null,
            ...
            referrals.map((p) =>
              /* @__PURE__ */ React.createElement("tr", { key: p.id, style: { borderTop: "1px solid #f0ede8" } },
                ...
                /* @__PURE__ */ React.createElement("td", { style: { padding: "12px 16px" } },
                  p.unpaid > 0 && /* @__PURE__ */ React.createElement("button", { onClick: () => handleMarkPaid(p.id, p.email), style: { padding: "4px 10px", background: "transparent", border: "1px solid #bbf7d0", color: "#15803d", borderRadius: 5, fontSize: 12, cursor: "pointer", fontFamily: "'DM Sans',sans-serif" } }, "Mark Paid"),
                  p.stripe_connect_id
                    ? /* @__PURE__ */ React.createElement("button", { onClick: async () => { if (!confirm("Pay $" + ((p.unpaid || 0) / 100).toFixed(2) + " to " + p.email + " via Stripe?")) return; const res = await fetch("/api/admin/referral/payout", { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify({ partner_id: p.id }) }); const d = await res.json(); alert(res.ok ? "\u2705 Paid $" + (d.amount || 0).toFixed(2) + " to " + p.email : "\u274C " + d.error); load(); }, style: { padding: "4px 10px", background: "#f0fdf4", color: "#15803d", border: "1px solid #bbf7d0", borderRadius: 5, fontSize: 12, cursor: "pointer", fontFamily: "'DM Sans',sans-serif", fontWeight: "bold" } }, "\uD83D\uDCB8 Pay Now")
                    : /* @__PURE__ */ React.createElement("button", { onClick: async () => { const res = await fetch("/api/admin/referral/create-connect-account", { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify({ partner_id: p.id, email: p.email }) }); const d = await res.json(); if (res.ok) alert("\u2705 Onboarding link sent to " + p.email); else alert("\u274C " + d.error); }, style: { padding: "4px 10px", background: "#eff6ff", color: "#1e40af", border: "1px solid #bfdbfe", borderRadius: 5, fontSize: 12, cursor: "pointer", fontFamily: "'DM Sans',sans-serif" } }, "\uD83D\uDCB3 Setup Pay"),
                  /* @__PURE__ */ React.createElement("button", { onClick: () => setEditPartner(p), style: { padding: "4px 10px", background: "#f0f7ff", color: "#1a2d5a", border: "1px solid #1a2d5a", borderRadius: 5, fontSize: 11, cursor: "pointer", fontFamily: "'DM Sans',sans-serif", fontWeight: "bold", display: "block", marginBottom: 4 } }, "\u270F\uFE0F Edit Profile"),
                  /* @__PURE__ */ React.createElement("button", { onClick: async () => { if (!confirm(`Remove referral partner ${p.email}?\nTheir user account will remain intact.`)) return; const res = await fetch("/api/admin/referral/delete", { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify({ partner_id: p.id }) }); if (res.ok) load(); else { const d = await res.json(); alert(`Error: ${d.error}`); } }, style: { padding: "4px 10px", background: "transparent", border: "1px solid #fecaca", color: "#dc2626", borderRadius: 5, fontSize: 11, cursor: "pointer", fontFamily: "'DM Sans',sans-serif", marginTop: 4, display: "block" } }, "\uD83D\uDDD1 Remove Partner")
                )
              )
            )
          )
    ...
    /* ===== PRO TAB ===== */
    tab === "pro" && /* @__PURE__ */ React.createElement("div", { style: { maxWidth: 1200, margin: "0 auto", padding: "0 24px 32px" } },
      /* Create Pro */
      /* @__PURE__ */ React.createElement("div", { style: { background: "#fff", borderRadius: 12, border: "1px solid #e8e4dc", padding: 24, marginBottom: 20 } },
        ...
        /* @__PURE__ */ React.createElement("div", { style: { display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12, marginBottom: 12 } },
          ...
          /* @__PURE__ */ React.createElement("div", { style: { gridColumn: "1 / -1" } }, /* @__PURE__ */ React.createElement("label", { style: { fontSize: 12, fontWeight: "bold", color: "#555", display: "block", marginBottom: 4 } }, "SCHEDULING SOFTWARE LINK (optional)"), /* @__PURE__ */ React.createElement("input", { value: proCal, onChange: (e) => setProCal(e.target.value), placeholder: "https://calendly.com/their-link or other scheduling link", style: inp })),/* @__PURE__ */ React.createElement("div", { style: { gridColumn: "1 / -1" } }, /* @__PURE__ */ React.createElement("label", { style: { fontSize: 12, fontWeight: "bold", color: "#555", display: "block", marginBottom: 4 } }, "CLIENT PAYMENT LINK (optional)"), /* @__PURE__ */ React.createElement("input", { value: proPayLink||"", onChange: (e) => setProPayLink(e.target.value), placeholder: "https://paypal.me/... or Square/Venmo link", style: inp }))
        ),
        /* @__PURE__ */ React.createElement("button", { onClick: handleCreatePro, style: { padding: "10px 22px", background: "#1a2d5a", color: "#7ec11f", border: "2px solid #7ec11f", borderRadius: 8, fontFamily: "'DM Sans',sans-serif", fontWeight: "bold", fontSize: 14, cursor: "pointer" } }, "Create Pro Subscriber \u2192"),
          ...
          /* @__PURE__ */ React.createElement("tbody", null,
            ...
            proSubs.map((p) =>
              /* @__PURE__ */ React.createElement("tr", { key: p.id, style: { borderTop: "1px solid #f0ede8" } },
                ...
                /* @__PURE__ */ React.createElement("td", { style: { padding: "12px 16px" } }, /* @__PURE__ */ React.createElement("span", { style: { fontSize: 11, padding: "2px 8px", borderRadius: 20, background: p.active ? "#f0fdf4" : "#f8f6f1", color: p.active ? "#15803d" : "#aaa", fontWeight: "bold" } }, p.active ? "Active" : "Pending Approval")),
                /* @__PURE__ */ React.createElement("td", { style: { padding: "12px 16px", minWidth: 200, verticalAlign: "top" } },
                  /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 5, alignItems: "flex-start" } },
                    !p.active && /* @__PURE__ */ React.createElement("button", { onClick: async () => { if (!confirm("Approve " + p.email + " and send referral link, Partner Guide + W-9?")) return; const res = await fetch("/api/admin/referral/approve", { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify({ id: p.id }) }); const d = await res.json(); alert(res.ok ? "\u2705 " + d.message : "\u274C " + (d.error||"")); load(); }, style: { padding: "4px 8px", background: "#f0fdf4", color: "#15803d", border: "2px solid #7ec11f", borderRadius: 5, fontSize: 11, cursor: "pointer", fontFamily: "'DM Sans',sans-serif", fontWeight: "bold" } }, "\uD83D\uDCDA Approve + Send Docs"),
                    p.stripe_customer_id
                      ? /* @__PURE__ */ React.createElement("button", { onClick: async () => { const r2 = await fetch("/api/admin/pro/billing-portal", { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify({ id: p.id }) }); const d2 = await r2.json(); if (r2.ok) window.open(d2.url, "_blank"); else alert(d2.error || "Error opening billing portal"); }, style: { padding: "4px 8px", background: "#1a2d5a", border: "1px solid #7ec11f", color: "#7ec11f", borderRadius: 5, fontSize: 11, cursor: "pointer", fontFamily: "'DM Sans',sans-serif" } }, "\uD83D\uDCB3 Billing Portal")
                      : /* @__PURE__ */ React.createElement("button", { onClick: () => handleSendSubLink(p.id, p.email), style: { padding: "4px 8px", background: "transparent", border: "1px solid #7ec11f", color: "#7ec11f", borderRadius: 5, fontSize: 11, cursor: "pointer", fontFamily: "'DM Sans',sans-serif" } }, "\uD83D\uDCB3 Get Billing Link"),
                    p.sessions_used > p.sessions_limit && /* @__PURE__ */ React.createElement("button", { onClick: () => handleChargeOverage(p.id, p.email, p.sessions_used - p.sessions_limit), style: { padding: "4px 8px", background: "transparent", border: "1px solid #fde68a", color: "#92400e", borderRadius: 5, fontSize: 11, cursor: "pointer", fontFamily: "'DM Sans',sans-serif" } }, "\u26A1 Charge Overage"),
                    /* @__PURE__ */ React.createElement("button", { onClick: () => handleOpenReseller(p), style: { padding: "4px 8px", background: p.reseller_mode ? "#7ec11f" : "transparent", border: "1px solid #7ec11f", color: p.reseller_mode ? "#1a2d5a" : "#7ec11f", borderRadius: 5, fontSize: 11, cursor: "pointer", fontFamily: "'DM Sans',sans-serif" } }, p.reseller_mode ? "\u2713 Reseller" : "Set Reseller"),
                    /* @__PURE__ */ React.createElement("button", { onClick: () => setEditProSub(p), style: { padding: "4px 8px", background: "#f0f7ff", color: "#1a2d5a", border: "1px solid #1a2d5a", borderRadius: 5, fontSize: 11, cursor: "pointer", fontFamily: "'DM Sans',sans-serif", fontWeight: "bold" } }, "\u270F\uFE0F Edit Branding"),
                    /* @__PURE__ */ React.createElement("a", { href: "/pro/requests/" + p.access_code, target: "_blank", style: { padding: "4px 8px", background: "#f0fdf4", color: "#15803d", border: "1px solid #7ec11f", borderRadius: 5, fontSize: 11, cursor: "pointer", fontFamily: "'DM Sans',sans-serif", fontWeight: "bold", textDecoration: "none", display: "inline-block" } }, "\uD83D\uDCCB Client Requests"),
                    /* @__PURE__ */ React.createElement("button", { onClick: () => handleResetSessions(p.id, p.email), style: { padding: "4px 8px", background: "transparent", border: "1px solid #bfdbfe", color: "#1e40af", borderRadius: 5, fontSize: 11, cursor: "pointer", fontFamily: "'DM Sans',sans-serif" } }, "Reset Sessions"),
                    p.active && /* @__PURE__ */ React.createElement("button", { onClick: () => handleDeactivatePro(p.id, p.email), style: { padding: "4px 8px", background: "transparent", border: "1px solid #fecaca", color: "#dc2626", borderRadius: 5, fontSize: 11, cursor: "pointer", fontFamily: "'DM Sans',sans-serif" } }, "Deactivate"),
                    /* @__PURE__ */ React.createElement("button", { onClick: async () => { if (!confirm(`Delete pro subscriber record for ${p.email}?\nTheir user account will remain intact.`)) return; const res = await fetch("/api/admin/pro/delete", { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify({ id: p.id }) }); if (res.ok) load(); else { const d = await res.json(); alert(`Error: ${d.error}`); } }, style: { padding: "4px 8px", background: "transparent", border: "1px solid #fecaca", color: "#dc2626", borderRadius: 5, fontSize: 11, cursor: "pointer", fontFamily: "'DM Sans',sans-serif", marginTop: 4 } }, "\uD83D\uDDD1 Delete")
                  )
                )
              )
            )
      ...
      /* @__PURE__ */ React.createElement("div", { style: { background: "#fff", borderRadius: 12, border: "1px solid #e8e4dc", padding: 24, marginTop: 20 } },
        ...
        /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 10, alignItems: "center", flexWrap: "wrap" } },
          /* @__PURE__ */ React.createElement("select", { value: clientLinkProduct, onChange: (e) => setClientLinkProduct(e.target.value), style: { ...inp, width: "auto", background: "#fff" } },
            ...
            /* @__PURE__ */ React.createElement("option", { value: "planning" }, "Tax Planning")
          ),
      ...
      resellerSub && /* @__PURE__ */ React.createElement("div", { style: { background: "#fff", borderRadius: 14, padding: 32, border: "2px solid #7ec11f", marginTop: 20 } },
        ...
        /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 10 } },
          /* @__PURE__ */ React.createElement("button", { onClick: handleSaveReseller, style: { flex: 1, padding: "11px", background: "#1a2d5a", color: "#7ec11f", border: "2px solid #7ec11f", borderRadius: 8, fontFamily: "'DM Sans',sans-serif", fontWeight: "bold", cursor: "pointer" } }, "Save Reseller Pricing \u2192"),
          /* @__PURE__ */ React.createElement("button", { onClick: () => setResellerSub(null), style: { padding: "11px 18px", background: "transparent", border: "1px solid #ddd", borderRadius: 8, fontFamily: "'DM Sans',sans-serif", cursor: "pointer" } }, "Cancel")
        ),
        resellerSub.reseller_mode && /* @__PURE__ */ React.createElement("button", { onClick: () => { handleDisableReseller(resellerSub.id); setResellerSub(null); }, style: { width: "100%", marginTop: 8, padding: "8px", background: "transparent", border: "1px solid #fecaca", color: "#dc2626", borderRadius: 8, fontFamily: "'DM Sans',sans-serif", fontSize: 12, cursor: "pointer" } }, "Disable Reseller Mode")
      )
    ),
    ...
    tab === "taxpro" && /* @__PURE__ */ React.createElement("div", { style: { maxWidth: 1100, margin: "0 auto", padding: "0 24px 32px" } },
      /* @__PURE__ */ React.createElement("div", { style: { background: "#fff", borderRadius: 12, border: "1px solid #e8e4dc", overflow: "hidden" } },
        /* @__PURE__ */ React.createElement("div", { style: { padding: "18px 24px", borderBottom: "1px solid #f0ede8", display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: 10 } }, /* @__PURE__ */ React.createElement("span", { style: { fontWeight: "bold", fontSize: 16, color: "#1a2d5a" } }, "Pro Subscription Interest Submissions (", interests.length, ")"), /* @__PURE__ */ React.createElement("a", { href: "/api/admin/taxpro/interests/export.csv", style: { background: "#1a2d5a", color: "#7ec11f", border: "2px solid #7ec11f", borderRadius: 7, padding: "7px 16px", textDecoration: "none", fontSize: 13, fontWeight: "bold" } }, "\uD83D\uDCE5 Export CSV for Mailchimp")),
        /* @__PURE__ */ React.createElement("div", { style: { overflowX: "auto" } },
                  ...
                  /* @__PURE__ */ React.createElement("tr", { style: { borderTop: "1px solid #f0ede8", background: p.status === "denied" ? "#fff5f5" : p.status === "approved" ? "#f0fdf4" : "#fff" } },
                    ...
                    /* @__PURE__ */ React.createElement("td", { style: { padding: "10px 12px" } },
                      /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 4, minWidth: 140 } },
                        /* @__PURE__ */ React.createElement("button", { onClick: async () => { setInterestMsg((m) => ({ ...m, [p.id]: "Sending..." })); const res = await fetch("/api/admin/taxpro/send-interest-letter", { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify({ id: p.id, name: p.name, email: p.email, firm: p.firm, program: p.program }) }); const d = await res.json(); setInterestMsg((m) => ({ ...m, [p.id]: res.ok ? "\u2705 Interest letter sent" : `\u274C ${d.error}` })); }, style: { padding: "4px 8px", background: "#eff6ff", color: "#1e40af", border: "1px solid #bfdbfe", borderRadius: 5, fontSize: 11, cursor: "pointer", fontFamily: "'DM Sans',sans-serif", fontWeight: "bold", textAlign: "left" } }, "\uD83D\uDCE8 Send Interest Letter"),
                        /* @__PURE__ */ React.createElement("button", { onClick: async () => { if (!confirm(`Approve ${p.name} for the pro subscription?`)) return; setInterestMsg((m) => ({ ...m, [p.id]: "Sending..." })); const res = await fetch("/api/admin/taxpro/send-approval-letter", { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify({ id: p.id, name: p.name, email: p.email, firm: p.firm }) }); const d = await res.json(); setInterestMsg((m) => ({ ...m, [p.id]: res.ok ? "\u2705 Approval letter sent" : `\u274C ${d.error}` })); if (res.ok) load(); }, style: { padding: "4px 8px", background: "#f0fdf4", color: "#15803d", border: "1px solid #bbf7d0", borderRadius: 5, fontSize: 11, cursor: "pointer", fontFamily: "'DM Sans',sans-serif", fontWeight: "bold", textAlign: "left" } }, "\u2705 Send Approval Letter"),
                        /* @__PURE__ */ React.createElement("button", { onClick: async () => { if (!confirm("Approve and send Partner Guide + W-9?")) return; setInterestMsg((m) => ({ ...m, [p.id]: "Sending..." })); const res = await fetch("/api/admin/pro/approve", { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify({ id: p.id }) }); const d = await res.json(); setInterestMsg((m) => ({ ...m, [p.id]: res.ok ? "\u2705 Approved + Docs Sent" : ("\u274C " + (d.error||"")) })); if (res.ok) load(); }, style: { padding: "4px 8px", background: "#f0fdf4", color: "#15803d", border: "2px solid #7ec11f", borderRadius: 5, fontSize: 11, cursor: "pointer", fontFamily: "'DM Sans',sans-serif", fontWeight: "bold", textAlign: "left" } }, "\uD83D\uDCDA Approve + Send Guide & W-9"),
                        /* @__PURE__ */ React.createElement("button", { onClick: async () => { if (!confirm(`Send denial email to ${p.name}?`)) return; setInterestMsg((m) => ({ ...m, [p.id]: "Sending..." })); const res = await fetch("/api/admin/taxpro/send-denial-letter", { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify({ id: p.id, name: p.name, email: p.email }) }); const d = await res.json(); setInterestMsg((m) => ({ ...m, [p.id]: res.ok ? "\u2705 Denial letter sent" : `\u274C ${d.error}` })); if (res.ok) load(); }, style: { padding: "4px 8px", background: "#fef2f2", color: "#dc2626", border: "1px solid #fecaca", borderRadius: 5, fontSize: 11, cursor: "pointer", fontFamily: "'DM Sans',sans-serif", fontWeight: "bold", textAlign: "left" } }, "\u2717 Send Denial Letter"),
                        /* @__PURE__ */ React.createElement("button", { onClick: async () => { if (!confirm(`Delete ${p.name} from the list?`)) return; await fetch("/api/admin/taxpro/delete-interest", { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify({ id: p.id }) }); load(); }, style: { padding: "4px 8px", background: "transparent", color: "#aaa", border: "1px solid #e8e4dc", borderRadius: 5, fontSize: 11, cursor: "pointer", fontFamily: "'DM Sans',sans-serif", textAlign: "left" } }, "\uD83D\uDDD1 Delete"),
    ...
    tab === "settings" && /* @__PURE__ */ React.createElement("div", { style: { maxWidth: 960, margin: "0 auto", padding: "0 24px 32px" } },
        ...
        /* @__PURE__ */ React.createElement("div", { style: { display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(180px, 1fr))", gap: 14, marginBottom: 16 } },
          [{ key: "navigator_price", label: "Navigator Price ($)" }, { key: "wizard_price", label: "Wizard Price ($)" }, { key: "bundle_price", label: "Bundle Price ($)" }, { key: "pro_intro_price", label: "Pro Intro Price ($/mo)" }, { key: "pro_standard_price", label: "Pro Standard ($/mo)" }, { key: "default_referral_commission", label: "Default Referral %" }].map((f) =>
            /* @__PURE__ */ React.createElement("div", { key: f.key },
              ...
              /* @__PURE__ */ React.createElement("input", { type: "number", value: settings[f.key] || "", onChange: (e) => setSettings((p) => ({ ...p, [f.key]: e.target.value })), style: { width: "100%", padding: "8px 10px", border: "1px solid #ddd", borderRadius: 8, fontSize: 14, fontFamily: "'DM Sans',sans-serif" } })
            )
          )
        ),
        /* @__PURE__ */ React.createElement("button", { onClick: async () => { setSettingsMsg(""); const res = await fetch("/api/admin/settings/save", { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify(settings) }); const d = await res.json(); setSettingsMsg(res.ok ? "\u2705 Settings saved." : `\u274C ${d.error}`); }, style: { padding: "9px 20px", background: "#1a2d5a", color: "#7ec11f", border: "2px solid #7ec11f", borderRadius: 8, fontFamily: "'DM Sans',sans-serif", fontWeight: "bold", fontSize: 13, cursor: "pointer" } }, "Save Settings"),
            ...
            /* @__PURE__ */ React.createElement("tbody", null,
              ...
              referrals.map((r) =>
                /* @__PURE__ */ React.createElement("tr", { key: r.id, style: { borderTop: "1px solid #f0ede8" } },
                  ...
                  /* @__PURE__ */ React.createElement("td", { style: { padding: "8px 12px" } }, /* @__PURE__ */ React.createElement("input", { type: "number", min: "1", max: "50", placeholder: "e.g. 25", defaultValue: r._newPct || r.custom_commission_pct || r.commission_pct, onChange: (e) => setReferrals((prev) => prev.map((x) => x.id === r.id ? { ...x, _newPct: e.target.value } : x)), style: { width: 70, padding: "5px 8px", border: "1px solid #ddd", borderRadius: 6, fontSize: 13, fontFamily: "'DM Sans',sans-serif" } })),
                  /* @__PURE__ */ React.createElement("td", { style: { padding: "8px 12px" } }, /* @__PURE__ */ React.createElement("button", { onClick: async () => { const pct = r._newPct || r.custom_commission_pct || r.commission_pct; const res = await fetch("/api/admin/referral/set-commission", { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify({ partner_id: r.id, commission_pct: parseInt(pct) }) }); if (res.ok) load(); }, style: { padding: "4px 10px", background: "#f0fdf4", color: "#15803d", border: "1px solid #bbf7d0", borderRadius: 5, fontSize: 11, cursor: "pointer", fontFamily: "'DM Sans',sans-serif", fontWeight: "bold" } }, "Update"))
                )
              )
            )
          )
      ...
      /* @__PURE__ */ React.createElement("div", { style: { background: "#fff", borderRadius: 12, border: "1px solid #e8e4dc", padding: 24, marginBottom: 20 } },
        ...
        /* @__PURE__ */ React.createElement("div", { style: { display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(160px, 1fr))", gap: 10, marginBottom: 12 } },
          /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("label", { style: { fontSize: 11, fontWeight: "bold", color: "#555", display: "block", marginBottom: 4 } }, "CODE *"), /* @__PURE__ */ React.createElement("input", { value: newDisc.code, onChange: (e) => setND("code", e.target.value.toUpperCase()), placeholder: "SAVE20", style: { width: "100%", padding: "8px 10px", border: "1px solid #ddd", borderRadius: 8, fontSize: 13, fontFamily: "'DM Sans',sans-serif" } })),
          /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("label", { style: { fontSize: 11, fontWeight: "bold", color: "#555", display: "block", marginBottom: 4 } }, "TYPE"), /* @__PURE__ */ React.createElement("select", { value: newDisc.discount_type, onChange: (e) => setND("discount_type", e.target.value), style: { width: "100%", padding: "8px 10px", border: "1px solid #ddd", borderRadius: 8, fontSize: 13, fontFamily: "'DM Sans',sans-serif" } }, /* @__PURE__ */ React.createElement("option", { value: "percent" }, "Percent (%)"), /* @__PURE__ */ React.createElement("option", { value: "flat" }, "Flat ($)"))),
          /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("label", { style: { fontSize: 11, fontWeight: "bold", color: "#555", display: "block", marginBottom: 4 } }, "AMOUNT *"), /* @__PURE__ */ React.createElement("input", { type: "number", value: newDisc.discount_amount, onChange: (e) => setND("discount_amount", e.target.value), placeholder: newDisc.discount_type === "percent" ? "20" : "15", style: { width: "100%", padding: "8px 10px", border: "1px solid #ddd", borderRadius: 8, fontSize: 13, fontFamily: "'DM Sans',sans-serif" } })),
          /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("label", { style: { fontSize: 11, fontWeight: "bold", color: "#555", display: "block", marginBottom: 4 } }, "APPLIES TO"), /* @__PURE__ */ React.createElement("select", { value: newDisc.applies_to, onChange: (e) => setND("applies_to", e.target.value), style: { width: "100%", padding: "8px 10px", border: "1px solid #ddd", borderRadius: 8, fontSize: 13, fontFamily: "'DM Sans',sans-serif" } }, /* @__PURE__ */ React.createElement("option", { value: "all" }, "All Products"), /* @__PURE__ */ React.createElement("option", { value: "navigator" }, "Navigator"), /* @__PURE__ */ React.createElement("option", { value: "wizard" }, "Wizard"), /* @__PURE__ */ React.createElement("option", { value: "bundle" }, "Bundle"), /* @__PURE__ */ React.createElement("option", { value: "planning" }, "Tax Planning"), /* @__PURE__ */ React.createElement("option", { value: "covid_penalty" }, "COVID Penalty Relief"), /* @__PURE__ */ React.createElement("option", { value: "pro" }, "Pro Subscription"))),
          /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("label", { style: { fontSize: 11, fontWeight: "bold", color: "#555", display: "block", marginBottom: 4 } }, "EXPIRES"), /* @__PURE__ */ React.createElement("input", { type: "date", value: newDisc.expires_at, onChange: (e) => setND("expires_at", e.target.value), style: { width: "100%", padding: "8px 10px", border: "1px solid #ddd", borderRadius: 8, fontSize: 13, fontFamily: "'DM Sans',sans-serif" } })),
          /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("label", { style: { fontSize: 11, fontWeight: "bold", color: "#555", display: "block", marginBottom: 4 } }, "MAX USES"), /* @__PURE__ */ React.createElement("input", { type: "number", value: newDisc.max_uses, onChange: (e) => setND("max_uses", e.target.value), placeholder: "Unlimited", style: { width: "100%", padding: "8px 10px", border: "1px solid #ddd", borderRadius: 8, fontSize: 13, fontFamily: "'DM Sans',sans-serif" } }))
        ),
        /* @__PURE__ */ React.createElement("button", { onClick: async () => { setDiscMsg(""); const res = await fetch("/api/admin/discount/create", { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify(newDisc) }); const d = await res.json(); if (res.ok) { setDiscMsg(`\u2705 Code "${d.code}" created.`); setNewDisc({ code: "", discount_type: "percent", discount_amount: "", applies_to: "all", expires_at: "", max_uses: "" }); load(); } else setDiscMsg(`\u274C ${d.error}`); }, style: { padding: "9px 20px", background: "#1a2d5a", color: "#7ec11f", border: "2px solid #7ec11f", borderRadius: 8, fontFamily: "'DM Sans',sans-serif", fontWeight: "bold", fontSize: 13, cursor: "pointer" } }, "Create Code"),
            ...
            /* @__PURE__ */ React.createElement("tbody", null,
              (data?.users || []).filter((u) => (u.purchases || []).length > 0).flatMap((u) => (u.purchases || []).map((p) => ({ ...p, email: u.email }))).map((p) =>
                /* @__PURE__ */ React.createElement("tr", { key: p.id, style: { borderTop: "1px solid #f0ede8" } },
                  ...
                  /* @__PURE__ */ React.createElement("td", { style: { padding: "8px 10px" } }, /* @__PURE__ */ React.createElement("input", { type: "date", defaultValue: p.expires_at?.slice(0, 10), onChange: (e) => p._newExpiry = e.target.value, style: { padding: "3px 6px", border: "1px solid #ddd", borderRadius: 5, fontSize: 11, fontFamily: "'DM Sans',sans-serif" } })),
                  /* @__PURE__ */ React.createElement("td", { style: { padding: "8px 10px" } }, /* @__PURE__ */ React.createElement("button", { onClick: async () => { if (!p._newExpiry) return; await fetch("/api/admin/purchase/extend", { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify({ purchase_id: p.id, expires_at: p._newExpiry }) }); load(); }, style: { padding: "3px 8px", background: "#f0fdf4", color: "#15803d", border: "1px solid #bbf7d0", borderRadius: 5, fontSize: 11, cursor: "pointer", fontFamily: "'DM Sans',sans-serif", fontWeight: "bold" } }, "Extend"))
                )
              ),
          ...
          /* @__PURE__ */ React.createElement("div", { key: fm.id, style: { borderTop: "1px solid #f0ede8", padding: "16px 24px" } },
            /* @__PURE__ */ React.createElement("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "flex-start", flexWrap: "wrap", gap: 10 } },
              ...
              /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 8 } },
                /* @__PURE__ */ React.createElement("button", { onClick: async () => { if (fmPartners[fm.id]) { setFmPartners((p) => ({ ...p, [fm.id]: null })); return; } const res = await fetch(`/api/admin/foundation/partners/${fm.id}`); const d = await res.json(); setFmPartners((p) => ({ ...p, [fm.id]: d.partners || [] })); }, style: { padding: "5px 12px", background: "#f0fdf4", color: "#15803d", border: "1px solid #bbf7d0", borderRadius: 6, fontSize: 12, cursor: "pointer", fontFamily: "'DM Sans',sans-serif", fontWeight: "bold" } }, fmPartners[fm.id] ? "Hide Partners" : "View Partners"),
                /* @__PURE__ */ React.createElement("button", { onClick: async () => { if (!confirm(`Approve ${fm.email} for Foundation and send $99/month payment link?`)) return; const res = await fetch("/api/admin/foundation/approve-and-invoice", { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify({ fm_id: fm.id }) }); const d = await res.json(); alert(res.ok ? "\u2705 " + d.message : "\u274C " + (d.error||"")); load(); }, style: { padding: "5px 12px", background: "#f0fdf4", color: "#15803d", border: "2px solid #7ec11f", borderRadius: 6, fontSize: 11, cursor: "pointer", fontFamily: "'DM Sans',sans-serif", fontWeight: "bold", marginRight: 6 } }, "\uD83D\uDCB3 Approve + Send Payment Link"),
                        /* @__PURE__ */ React.createElement("button", { onClick: async () => { if (!confirm(`Remove Foundation Member status from ${fm.email}?`)) return; await fetch("/api/admin/foundation/deactivate", { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify({ id: fm.id }) }); load(); }, style: { padding: "5px 12px", background: "transparent", color: "#dc2626", border: "1px solid #fecaca", borderRadius: 6, fontSize: 12, cursor: "pointer", fontFamily: "'DM Sans',sans-serif" } }, "Remove"),
                /* @__PURE__ */ React.createElement("button", { onClick: async () => { const res = await fetch(`/api/admin/foundation/recruitment-link/${fm.id}`); const d = await res.json(); if (res.ok) { navigator.clipboard.writeText(d.link); alert(`\u2705 Recruitment link copied!\n\n${d.link}`); } else alert(`\u274C ${d.error}`); }, style: { padding: "5px 12px", background: "#f0fdf4", color: "#15803d", border: "1px solid #bbf7d0", borderRadius: 6, fontSize: 12, cursor: "pointer", fontFamily: "'DM Sans',sans-serif", fontWeight: "bold" } }, "\uD83D\uDD17 Copy Recruit Link")
              )
            ),
            /* Assign Partner */
            /* @__PURE__ */ React.createElement("div", { style: { marginTop: 12, display: "flex", gap: 8, alignItems: "center", flexWrap: "wrap" } },
              ...
              /* @__PURE__ */ React.createElement("select", { style: { padding: "4px 8px", border: "1px solid #ddd", borderRadius: 6, fontSize: 12, fontFamily: "'DM Sans',sans-serif" }, id: `partner-select-${fm.id}` },
...
,
  editUser && React.createElement(EditUserModal, { user: editUser, onClose: function(){ setEditUser(null); }, onSave: load }),
  editProSub && React.createElement(EditProSubModal, { sub: editProSub, onClose: function(){ setEditProSub(null); }, onSave: load }),
  editPartner && React.createElement(EditPartnerModal, { partner: editPartner, onClose: function(){ setEditPartner(null); }, onSave: load }));
}

function EditUserModal(props) {
  var user = props.user; var onClose = props.onClose; var onSave = props.onSave;
  var eState = React.useState(user.email || ""); var email = eState[0]; var setEmail = eState[1];
  var nState = React.useState(user.name || ""); var uname = nState[0]; var setUname = nState[1];
  var fState = React.useState(user.firm || user.pro_firm || ""); var firm = fState[0]; var setFirm = fState[1];
  var pState = React.useState(user.phone || ""); var phone = pState[0]; var setPhone = pState[1];
  var cState = React.useState(user.credential || ""); var cred = cState[0]; var setCred = cState[1];
  var wState = React.useState(user.website || ""); var website = wState[0]; var setWebsite = wState[1];
  var aState = React.useState(user.address || ""); var address = aState[0]; var setAddress = aState[1];
  var sState = React.useState(false); var saving = sState[0]; var setSaving = sState[1];
  ...
  var inp = { width:"100%", border:"1px solid #e8e4dc", borderRadius:7, padding:"9px 12px", fontSize:13, fontFamily:"'DM Sans',sans-serif", boxSizing:"border-box", marginBottom:12 };
  var lbl = { display:"block", fontSize:11, fontWeight:"bold", color:"#1a2d5a", marginBottom:3, textTransform:"uppercase" };
  function save() {
    setSaving(true); setErr(""); setMsg("");
    var reqs = [fetch("/api/admin/user/update", { method:"POST", headers:{"Content-Type":"application/json"}, body: JSON.stringify({ user_id: user.id, email: email, name: uname }) })];
    if (user.partner_id) reqs.push(fetch("/api/admin/partner/update", { method:"POST", headers:{"Content-Type":"application/json"}, body: JSON.stringify({ partner_id: user.partner_id, name: uname, firm: firm, phone: phone, credential: cred, website: website, address: address }) }));
    if (user.pro_id) reqs.push(fetch("/api/admin/pro/update-profile", { method:"POST", headers:{"Content-Type":"application/json"}, body: JSON.stringify({ pro_id: user.pro_id, firm_name: firm, contact_name: uname, contact_phone: phone }) }));
    Promise.all(reqs).then(function(results) {
      setSaving(false);
      if (results.every(function(r){ return r.ok; })) { setMsg("\u2705 Saved"); setTimeout(function(){ onSave(); onClose(); }, 800); }
      else { setErr("Some updates failed. Please try again."); }
    });
  }
  return React.createElement("div", { style:{ position:"fixed", inset:0, background:"rgba(0,0,0,0.55)", zIndex:9000, display:"flex", alignItems:"center", justifyContent:"center", padding:16 } },
    React.createElement("div", { style:{ background:"#fff", borderRadius:14, padding:"28px 28px", maxWidth:500, width:"100%", maxHeight:"90vh", overflowY:"auto" } },
      React.createElement("div", { style:{ display:"flex", justifyContent:"space-between", alignItems:"center", marginBottom:16 } },
        React.createElement("div", { style:{ fontWeight:"bold", fontSize:17, color:"#1a2d5a" } }, "Edit User"),
        React.createElement("button", { onClick:onClose, style:{ background:"none", border:"none", fontSize:20, cursor:"pointer", color:"#aaa" } }, "\u00D7")
      ),
      React.createElement("div", { style:{ background:"#f8f6f1", borderRadius:7, padding:"8px 12px", fontSize:12, color:"#888", marginBottom:14 } }, "ID: " + user.id + (user.partner_id ? " \u00b7 Partner: " + user.code : "") + (user.pro_id ? " \u00b7 Pro Subscriber" : "")),
      React.createElement("label", { style:lbl }, "Email Address"), React.createElement("input", { style:inp, value:email, onChange:function(e){setEmail(e.target.value);} }),
      React.createElement("label", { style:lbl }, "Full Name"), React.createElement("input", { style:inp, value:uname, onChange:function(e){setUname(e.target.value);} }),
      (user.partner_id || user.pro_id) && React.createElement("div", null,
        React.createElement("label", { style:lbl }, "Firm Name"), React.createElement("input", { style:inp, value:firm, onChange:function(e){setFirm(e.target.value);} }),
        React.createElement("label", { style:lbl }, "Phone"), React.createElement("input", { style:inp, value:phone, onChange:function(e){setPhone(e.target.value);} }),
        user.partner_id && React.createElement("div", null,
          React.createElement("label", { style:lbl }, "Credential"), React.createElement("input", { style:inp, value:cred, onChange:function(e){setCred(e.target.value);} }),
          React.createElement("label", { style:lbl }, "Website"), React.createElement("input", { style:inp, value:website, onChange:function(e){setWebsite(e.target.value);} }),
          React.createElement("label", { style:lbl }, "Address"), React.createElement("input", { style:inp, value:address, onChange:function(e){setAddress(e.target.value);} })
        )
      ),
      err && React.createElement("div", { style:{ background:"#fef2f2", border:"1px solid #fca5a5", borderRadius:7, padding:"10px", fontSize:13, color:"#dc2626", marginBottom:10 } }, err),
      msg && React.createElement("div", { style:{ background:"#f0fdf4", border:"1px solid #7ec11f", borderRadius:7, padding:"10px", fontSize:13, color:"#15803d", marginBottom:10 } }, msg),
      React.createElement("div", { style:{ display:"flex", gap:10 } },
        React.createElement("button", { onClick:save, disabled:saving, style:{ flex:1, background:"#1a2d5a", color:"#7ec11f", border:"2px solid #7ec11f", borderRadius:8, padding:"11px", fontFamily:"'DM Sans',sans-serif", fontWeight:"bold", fontSize:14, cursor:"pointer" } }, saving ? "Saving..." : "Save Changes"),
        React.createElement("button", { onClick:onClose, style:{ background:"transparent", color:"#aaa", border:"1px solid #e8e4dc", borderRadius:8, padding:"11px 16px", fontFamily:"'DM Sans',sans-serif", fontSize:13, cursor:"pointer" } }, "Cancel")
      )
    )
  );
}

function EditProSubModal(props) {
  var sub = props.sub; var onClose = props.onClose; var onSave = props.onSave;
  var fState = React.useState(sub.firm_name || ""); var firm = fState[0]; var setFirm = fState[1];
  var nState = React.useState(sub.contact_name || ""); var name = nState[0]; var setName = nState[1];
  var pState = React.useState(sub.contact_phone || ""); var phone = pState[0]; var setPhone = pState[1];
  var cState = React.useState(sub.calendly_url || ""); var calUrl = cState[0]; var setCalUrl = cState[1];
  var plState = React.useState(sub.payment_link || ""); var payLink = plState[0]; var setPayLink = plState[1];
  var sState = React.useState(false); var saving = sState[0]; var setSaving = sState[1];
  var mState = React.useState(""); var msg = mState[0]; var setMsg = mState[1];
  var inp = { width:"100%", border:"1px solid #e8e4dc", borderRadius:7, padding:"9px 12px", fontSize:13, fontFamily:"'DM Sans',sans-serif", boxSizing:"border-box", marginBottom:12 };
  var lbl = { display:"block", fontSize:11, fontWeight:"bold", color:"#1a2d5a", marginBottom:3, textTransform:"uppercase" };
  function save() {
    setSaving(true); setMsg("");
    fetch("/api/admin/pro/update-profile", { method:"POST", headers:{"Content-Type":"application/json"},
      body: JSON.stringify({ pro_id: sub.id, firm_name: firm, contact_name: name, contact_phone: phone, calendly_url: calUrl, payment_link: payLink })
    }).then(function(r){ return r.json(); }).then(function(d){
      setSaving(false);
      if (d.ok) { setMsg("\u2705 Saved"); setTimeout(function(){ onSave(); onClose(); }, 800); }
      else { setMsg("\u274C " + (d.error||"Error")); }
    });
  }
  return React.createElement("div", { style:{ position:"fixed", inset:0, background:"rgba(0,0,0,0.55)", zIndex:9000, display:"flex", alignItems:"center", justifyContent:"center", padding:16 } },
    React.createElement("div", { style:{ background:"#fff", borderRadius:14, padding:"28px", maxWidth:480, width:"100%" } },
      React.createElement("div", { style:{ display:"flex", justifyContent:"space-between", alignItems:"center", marginBottom:16 } },
        React.createElement("div", { style:{ fontWeight:"bold", fontSize:17, color:"#1a2d5a" } }, "Edit Pro Subscriber — " + sub.firm_name),
        React.createElement("button", { onClick:onClose, style:{ background:"none", border:"none", fontSize:20, cursor:"pointer", color:"#aaa" } }, "\u00D7")
      ),
      React.createElement("label", { style:lbl }, "Firm Name"), React.createElement("input", { style:inp, value:firm, onChange:function(e){setFirm(e.target.value);} }),
      React.createElement("label", { style:lbl }, "Contact Name"), React.createElement("input", { style:inp, value:name, onChange:function(e){setName(e.target.value);} }),
      React.createElement("label", { style:lbl }, "Contact Phone"), React.createElement("input", { style:inp, value:phone, onChange:function(e){setPhone(e.target.value);} }),
      React.createElement("label", { style:lbl }, "Scheduling Software Link"), React.createElement("input", { style:inp, placeholder:"https://calendly.com/...", value:calUrl, onChange:function(e){setCalUrl(e.target.value);} }),React.createElement("label", { style:lbl }, "Client Payment Link (optional)"), React.createElement("input", { style:inp, placeholder:"https://paypal.me/yourname or Square/Venmo link", value:payLink, onChange:function(e){setPayLink(e.target.value);} }),
      msg && React.createElement("div", { style:{ padding:"10px", borderRadius:7, fontSize:13, marginBottom:10, color: msg.startsWith("\u2705") ? "#15803d" : "#dc2626", background: msg.startsWith("\u2705") ? "#f0fdf4" : "#fef2f2", border: "1px solid " + (msg.startsWith("\u2705") ? "#7ec11f" : "#fca5a5") } }, msg),
      React.createElement("div", { style:{ display:"flex", gap:10 } },
        React.createElement("button", { onClick:save, disabled:saving, style:{ flex:1, background:"#1a2d5a", color:"#7ec11f", border:"2px solid #7ec11f", borderRadius:8, padding:"11px", fontFamily:"'DM Sans',sans-serif", fontWeight:"bold", fontSize:14, cursor:"pointer" } }, saving ? "Saving..." : "Save Changes"),
        React.createElement("button", { onClick:onClose, style:{ background:"transparent", color:"#aaa", border:"1px solid #e8e4dc", borderRadius:8, padding:"11px 16px", fontFamily:"'DM Sans',sans-serif", fontSize:13, cursor:"pointer" } }, "Cancel")
      )
...
function EditPartnerModal(props) {
  var partner = props.partner; var onClose = props.onClose; var onSave = props.onSave;
  var nState = React.useState(partner.name || ""); var name = nState[0]; var setName = nState[1];
  var fState = React.useState(partner.firm || ""); var firm = fState[0]; var setFirm = fState[1];
  var pState = React.useState(partner.phone || ""); var phone = pState[0]; var setPhone = pState[1];
  var cState = React.useState(partner.credential || ""); var cred = cState[0]; var setCred = cState[1];
  var wState = React.useState(partner.website || ""); var website = wState[0]; var setWebsite = wState[1];
  var aState = React.useState(partner.address || ""); var address = aState[0]; var setAddress = aState[1];
  var sState = React.useState(false); var saving = sState[0]; var setSaving = sState[1];
  var mState = React.useState(""); var msg = mState[0]; var setMsg = mState[1];
  var inp = { width:"100%", border:"1px solid #e8e4dc", borderRadius:7, padding:"9px 12px", fontSize:13, fontFamily:"'DM Sans',sans-serif", boxSizing:"border-box", marginBottom:12 };
  var lbl = { display:"block", fontSize:11, fontWeight:"bold", color:"#1a2d5a", marginBottom:3, textTransform:"uppercase" };
  function save() {
    setSaving(true); setMsg("");
    fetch("/api/admin/partner/update", { method:"POST", headers:{"Content-Type":"application/json"},
      body: JSON.stringify({ partner_id: partner.id, name: name, firm: firm, phone: phone, credential: cred, website: website, address: address })
    }).then(function(r){ return r.json(); }).then(function(d){
      setSaving(false);
      if (d.ok) { setMsg("\u2705 Saved"); setTimeout(function(){ onSave(); onClose(); }, 800); }
      else { setMsg("\u274C " + (d.error||"Error")); }
  ...
  return React.createElement("div", { style:{ position:"fixed", inset:0, background:"rgba(0,0,0,0.55)", zIndex:9000, display:"flex", alignItems:"center", justifyContent:"center", padding:16 } },
    React.createElement("div", { style:{ background:"#fff", borderRadius:14, padding:"28px", maxWidth:480, width:"100%" } },
      React.createElement("div", { style:{ display:"flex", justifyContent:"space-between", alignItems:"center", marginBottom:16 } },
        React.createElement("div", { style:{ fontWeight:"bold", fontSize:17, color:"#1a2d5a" } }, "Edit Referral Partner — " + (partner.email||"")),
        React.createElement("button", { onClick:onClose, style:{ background:"none", border:"none", fontSize:20, cursor:"pointer", color:"#aaa" } }, "\u00D7")
      ),
      React.createElement("div", { style:{ background:"#f8f6f1", borderRadius:7, padding:"8px 12px", fontSize:12, color:"#888", marginBottom:14 } }, "Code: " + (partner.code||"—") + " \u00b7 Commission: " + (partner.commission_pct||20) + "%"),
      React.createElement("label", { style:lbl }, "Full Name"), React.createElement("input", { style:inp, value:name, onChange:function(e){setName(e.target.value);} }),
      React.createElement("label", { style:lbl }, "Firm Name"), React.createElement("input", { style:inp, value:firm, onChange:function(e){setFirm(e.target.value);} }),
      React.createElement("label", { style:lbl }, "Phone"), React.createElement("input", { style:inp, value:phone, onChange:function(e){setPhone(e.target.value);} }),
      React.createElement("label", { style:lbl }, "Credential"), React.createElement("input", { style:inp, value:cred, onChange:function(e){setCred(e.target.value);} }),
      React.createElement("label", { style:lbl }, "Website"), React.createElement("input", { style:inp, value:website, onChange:function(e){setWebsite(e.target.value);} }),
