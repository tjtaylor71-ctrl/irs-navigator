...
function AdminPage() {
  ...
  const productColors = { navigator: "#1a1a2e", wizard: "#1e3a8a", bundle: "#7c2d12" };
  ...
  return /* @__PURE__ */ React.createElement("div", { style: { fontFamily: "Georgia, serif", background: "#f8f6f1", minHeight: "100vh" } }, /* @__PURE__ */ React.createElement("div", { style: { background: "#1a1a2e", padding: "16px 24px", borderBottom: "3px solid #c8a96e" } }, /* @__PURE__ */ React.createElement("div", { style: { maxWidth: 960, margin: "0 auto", display: "flex", justifyContent: "space-between", alignItems: "center" } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 12 } }, /* @__PURE__ */ React.createElement("div", { style: { width: 36, height: 36, background: "#c8a96e", borderRadius: 8, display: "flex", alignItems: "center", justifyContent: "center", fontSize: 18 } }, "\u2696\uFE0F"), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { style: { color: "#fff", fontWeight: "bold", fontSize: 16 } }, "IRS Navigator"), /* @__PURE__ */ React.createElement("div", { style: { color: "#c8a96e", fontSize: 11, letterSpacing: 1 } }, "ADMIN PANEL"))), /* @__PURE__ */ React.createElement("a", { href: "/", style: { color: "#aaa", fontSize: 13, textDecoration: "none", border: "1px solid #444", padding: "6px 14px", borderRadius: 6 } }, "\u2190 Home"))), /* @__PURE__ */ React.createElement("div", { style: { maxWidth: 960, margin: "0 auto", padding: "32px 24px" } }, /* @__PURE__ */ React.createElement("div", { style: { display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 16, marginBottom: 28 } }, [
  ...
  ].map((s) => /* @__PURE__ */ React.createElement("div", { key: s.label, style: { background: "#fff", borderRadius: 12, border: "1px solid #e8e4dc", padding: "20px 20px" } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 28, fontWeight: "bold", color: "#1a1a2e" } }, s.value), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 13, color: "#888", marginTop: 4 } }, s.label)))), /* @__PURE__ */ React.createElement("div", { style: { background: "#fff", borderRadius: 12, border: "1px solid #e8e4dc", padding: "24px", marginBottom: 24 } }, /* @__PURE__ */ React.createElement("div", { style: { fontWeight: "bold", fontSize: 16, marginBottom: 16, color: "#1a1a2e" } }, "Grant Access"), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 10, alignItems: "center", flexWrap: "wrap" } }, /* @__PURE__ */ React.createElement(
    "input",
    {
      value: grantEmail,
    ...
    {
      onClick: handleGrant,
      style: { padding: "9px 20px", background: "#1a1a2e", color: "#c8a96e", border: "2px solid #c8a96e", borderRadius: 7, fontFamily: "Georgia, serif", fontWeight: "bold", fontSize: 14, cursor: "pointer" }
    },
    "Grant \u2192"
  )), grantMsg && /* @__PURE__ */ React.createElement("div", { style: { marginTop: 10, fontSize: 13, color: grantMsg.startsWith("\u2705") ? "#15803d" : "#dc2626" } }, grantMsg)), /* @__PURE__ */ React.createElement("div", { style: { background: "#fff", borderRadius: 12, border: "1px solid #e8e4dc", overflow: "hidden" } }, /* @__PURE__ */ React.createElement("div", { style: { padding: "20px 24px", borderBottom: "1px solid #f0ede8", display: "flex", justifyContent: "space-between", alignItems: "center" } }, /* @__PURE__ */ React.createElement("div", { style: { fontWeight: "bold", fontSize: 16, color: "#1a1a2e" } }, "Users (", filtered.length, ")"), /* @__PURE__ */ React.createElement(
    "input",
    {
      value: search,
