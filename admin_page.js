                ...
                /* @__PURE__ */ React.createElement("tr", { key: user.id, style: { borderTop: "1px solid #f0ede8" } },
                  ...
                  /* @__PURE__ */ React.createElement("td", { style: { padding: "12px 16px" } },
                    /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 6, flexWrap: "wrap" } },
                      ...
                      /* @__PURE__ */ React.createElement("button", { onClick: () => setEditUser(user), style: { padding: "4px 10px", background: "#f0f7ff", color: "#1a2d5a", border: "1px solid #1a2d5a", borderRadius: 5, fontSize: 11, cursor: "pointer", fontFamily: "'DM Sans',sans-serif", fontWeight: "bold", marginRight: 4 } }, "\u270F\uFE0F Edit"),
                      /* @__PURE__ */ React.createElement("button", {
                        onClick: async () => {
