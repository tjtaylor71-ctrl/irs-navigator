...
function AdminPage() {
  ...
  const [showAdminAccounts, setShowAdminAccounts] = React.useState(false);
  ...
  const allUsers = showAdminAccounts
    ? [...(data?.users || []), ...(data?.admin_users || [])]
    : (data?.users || []);
  ...
  return /* @__PURE__ */ React.createElement("div", { style: { fontFamily: "Georgia, serif", background: "#f8f6f1", minHeight: "100vh" } },
    ...
    /* HEADER */
    /* @__PURE__ */ React.createElement("div", { style: { background: "#1a2d5a", padding: "16px 24px", borderBottom: "3px solid #7ec11f" } },
      /* @__PURE__ */ React.createElement("div", { style: { maxWidth: 960, margin: "0 auto", display: "flex", justifyContent: "space-between", alignItems: "center" } },
        /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 12 } },
          /* @__PURE__ */ React.createElement("img", { src: "/static/logo.png", alt: "IRS Pilot", style: { width: 44, height: 44, objectFit: "contain" } }),
          /* @__PURE__ */ React.createElement("div", null,
            /* @__PURE__ */ React.createElement("div", { style: { color: "#fff", fontWeight: "bold", fontSize: 16 } }, "IRS Pilot"),
            /* @__PURE__ */ React.createElement("div", { style: { color: "#7ec11f", fontSize: 11, letterSpacing: 1 } }, "ADMIN PANEL")
          )
        ),
        /* @__PURE__ */ React.createElement("a", { href: "/", style: { color: "#aaa", fontSize: 13, textDecoration: "none", border: "1px solid #444", padding: "6px 14px", borderRadius: 6 } }, "\u2190 Home")
      )
    ),
    ...
    tab === "users" && /* @__PURE__ */ React.createElement("div", { style: { maxWidth: 960, margin: "0 auto", padding: "0 24px 32px" } },
      /* Stats */
      /* @__PURE__ */ React.createElement("div", { style: { display: "grid", gridTemplateColumns: "repeat(5, 1fr)", gap: 16, marginBottom: 24 } },
        [{ label: "Total Users", value: data?.stats?.total_users || 0 }, { label: "Active Purchases", value: data?.stats?.active_purchases || 0 }, { label: "Navigator Access", value: data?.stats?.navigator_count || 0 }, { label: "Wizard Access", value: data?.stats?.wizard_count || 0 }, { label: "Total Revenue", value: data?.stats?.total_revenue > 0 ? "$" + data.stats.total_revenue : "$0" }].map((s) =>
      ...
      /* @__PURE__ */ React.createElement("div", { style: { background: "#fff", borderRadius: 12, border: "1px solid #e8e4dc", overflow: "hidden" } },
        /* @__PURE__ */ React.createElement("div", { style: { padding: "20px 24px", borderBottom: "1px solid #f0ede8", display: "flex", justifyContent: "space-between", alignItems: "center" } },
          ...
          /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 10, alignItems: "center" } },
            /* @__PURE__ */ React.createElement("button", { onClick: () => setShowAdminAccounts(!showAdminAccounts), style: { padding: "7px 14px", background: showAdminAccounts ? "#1a2d5a" : "#f0f7e8", border: "1.5px solid " + (showAdminAccounts ? "#7ec11f" : "#cce8a0"), borderRadius: 7, fontSize: 12, fontFamily: "Georgia, serif", fontWeight: "bold", color: showAdminAccounts ? "#7ec11f" : "#555", cursor: "pointer" } }, showAdminAccounts ? "\u2714 Showing Admin Accounts" : "Show Admin Accounts"),
