...
function EditUserModal(props) {
  ...
  function save() {
    ...
    if (user.pro_id) reqs.push(fetch("/api/admin/pro/update", { method:"POST", headers:{"Content-Type":"application/json"}, body: JSON.stringify({ pro_id: user.pro_id, firm_name: firm, contact_name: uname, contact_phone: phone }) }));
