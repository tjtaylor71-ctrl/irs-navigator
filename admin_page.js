            ...
            referrals.map((p) =>
              /* @__PURE__ */ React.createElement("tr", { key: p.id, style: { borderTop: "1px solid #f0ede8" } },
                ...
                /* @__PURE__ */ React.createElement("td", { style: { padding: "12px 16px" } },
                  ...
                  /* @__PURE__ */ React.createElement("button", { onClick: async () => { if (!confirm("Resend referral link, Partner Guide + W-9 to " + p.email + "?")) return; const res = await fetch("/api/admin/referral/resend-documents", { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify({ id: p.id }) }); const d = await res.json(); alert(res.ok ? "\u2705 " + d.message : "\u274C " + (d.error || d.warning || "")); }, style: { padding: "4px 10px", background: "transparent", border: "1px solid #bfdbfe", color: "#1e40af", borderRadius: 5, fontSize: 12, cursor: "pointer", fontFamily: "'DM Sans',sans-serif" } }, "\uD83D\uDCE7 Resend Docs"),
          ...
          /* @__PURE__ */ React.createElement("tbody", null,
            ...
            proSubs.map((p) =>
              /* @__PURE__ */ React.createElement("tr", { key: p.id, style: { borderTop: "1px solid #f0ede8" } },
                ...
                /* @__PURE__ */ React.createElement("td", { style: { padding: "12px 16px", fontFamily: "monospace", fontWeight: "bold", color: "#1a2d5a" } },
                  p.access_code,
                  p.subdomain
                    ? /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, color: "#15803d", marginTop: 3, fontWeight: "normal" } }, p.subdomain, ".irspilot.com")
                    : null
                ),
                /* @__PURE__ */ React.createElement("td", { style: { padding: "12px 16px" } },
                ...
                /* @__PURE__ */ React.createElement("td", { style: { padding: "12px 16px" } },
                  /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 5, flexWrap: "wrap" } },
                    ...
                    p.active && /* @__PURE__ */ React.createElement("button", { onClick: async () => { if (!confirm("Resend welcome email + Tax Pro Guide to " + p.email + "?")) return; const res = await fetch("/api/admin/pro/resend-welcome", { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify({ id: p.id }) }); const d = await res.json(); alert(res.ok ? "\u2705 " + d.message : "\u274C " + (d.error || d.warning || "")); }, style: { padding: "4px 8px", background: "transparent", border: "1px solid #bfdbfe", color: "#1e40af", borderRadius: 5, fontSize: 11, cursor: "pointer", fontFamily: "'DM Sans',sans-serif" } }, "\uD83D\uDCE7 Resend Welcome"),
                    p.active && /* @__PURE__ */ React.createElement("button", { onClick: async () => { if (!confirm("Resend Pro Approval email (Partner Guide + W-9) to " + p.email + "?")) return; const res = await fetch("/api/admin/pro/resend-approval-docs", { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify({ id: p.id }) }); const d = await res.json(); alert(res.ok ? "\u2705 " + d.message : "\u274C " + (d.error || d.warning || "")); }, style: { padding: "4px 8px", background: "transparent", border: "1px solid #7ec11f", color: "#15803d", borderRadius: 5, fontSize: 11, cursor: "pointer", fontFamily: "'DM Sans',sans-serif" } }, "\uD83D\uDCC4 Resend Guide + W-9"),
                    ...
                    /* @__PURE__ */ React.createElement("button", { onClick: async () => { const slug = prompt(p.subdomain ? "Change subdomain for " + p.email + " (currently: " + p.subdomain + ".irspilot.com)" : "Set a subdomain for " + p.email + " (e.g. \"rockymountaintax\")"); if (!slug) return; const res = await fetch("/api/admin/pro/set-subdomain", { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify({ id: p.id, subdomain: slug }) }); const d = await res.json(); alert(res.ok ? "\u2705 " + d.message : "\u274C " + (d.error || "")); if (res.ok) load(); }, style: { padding: "4px 8px", background: "transparent", border: "1px solid #7ec11f", color: "#15803d", borderRadius: 5, fontSize: 11, cursor: "pointer", fontFamily: "'DM Sans',sans-serif" } }, p.subdomain ? "\uD83C\uDF10 Change Subdomain" : "\uD83C\uDF10 Set Subdomain"),
