...
<div class="layout">
  ...
  <div class="main">
    <div class="tabs">
      ...
      <div class="tab" data-tab="facebook">Workflow Guide</div>
    </div>
    ...
    <div class="pane" id="pane-banners">
      <div class="theme-box">
        ...
        <div class="btn-row">
          ...
          <button class="btn btn-dark" onclick="sendTdmToBuffer('banners')" style="font-size:12px;">Send to Buffer</button>
    ...
    <div class="pane" id="pane-shorts">
      <div class="theme-box">
        ...
        <div class="btn-row">
          ...
          <button class="btn btn-dark" onclick="sendTdmToBuffer('short')" style="font-size:12px;">Send to Buffer</button>
    ...
    <div class="pane" id="pane-longs">
      <div class="theme-box">
        ...
        <div class="btn-row">
          ...
          <button class="btn btn-dark" onclick="sendTdmToBuffer('long')" style="font-size:12px;">Send to Buffer</button>
    ...
    <div class="pane" id="pane-facebook">
      <div class="alert alert-gold" style="margin-bottom:18px;"><strong>TDM Daily Workflow</strong> &mdash; Generate content here, then publish via Meta Business Suite.</div>

      <div class="setup-sec">
        <h3>Step 1 &mdash; Run TDM Daily</h3>
        <ol class="step-list">
          <li>Go to <strong>Image Posts</strong> tab</li>
          <li>Set count to <strong>15</strong> (or your preferred number)</li>
          <li>Click <strong>&#9654; Run TDM Daily</strong></li>
          <li>Review posts and click <strong>Approve All</strong> (or select individual ones)</li>
        </ol>
      </div>

      <div class="setup-sec">
        <h3>Step 2 &mdash; Generate Images in OpenArt</h3>
        <ol class="step-list">
          <li>Click <strong>&#8595; OpenArt Prompts</strong> to download all image prompts as a .txt file</li>
          <li>Go to <a href="https://openart.ai/image/bulk" target="_blank" style="color:var(--gold);">openart.ai/image/bulk</a></li>
          <li>Upload the .txt file &mdash; select <strong>Nano Banana 2</strong> model</li>
          <li>Generate all images at once &mdash; they save to your OpenArt library</li>
        </ol>
      </div>

      <div class="setup-sec">
        <h3>Step 3 &mdash; Publish via Meta Business Suite</h3>
        <ol class="step-list">
          <li>Go to <a href="https://business.facebook.com" target="_blank" style="color:var(--gold);">business.facebook.com</a> &rarr; <strong>Planner</strong></li>
          <li>Click <strong>Create post</strong></li>
          <li>Select <strong>Tiny Dog Mafia</strong> Facebook + Instagram</li>
          <li>Paste caption from TDM Studio (copy from each card)</li>
          <li>Upload the OpenArt-generated image</li>
          <li>Schedule using your posting calendar</li>
        </ol>
      </div>

      <div class="setup-sec">
        <h3>Step 4 &mdash; Video Content</h3>
        <ol class="step-list">
          <li>Go to <strong>Short Videos</strong> or <strong>Long Videos</strong> tab</li>
          <li>Generate 3 video packages</li>
          <li>Click <strong>&#8595; OpenArt Prompts</strong> to download image prompts</li>
          <li>Generate images in OpenArt &rarr; animate with <strong>Seedance</strong> or <strong>Kling</strong></li>
          <li>Use OpenArt TTS for voiceover &rarr; assemble in <strong>CapCut</strong></li>
          <li>Post finished video via Meta Business Suite</li>
        </ol>
      </div>

      <div class="setup-sec" style="background:var(--dark2);border-radius:8px;padding:14px;">
        <h3 style="margin-top:0;">Quick Links</h3>
        <div style="display:flex;flex-wrap:wrap;gap:8px;margin-top:8px;">
          <a href="https://business.facebook.com" target="_blank" class="btn btn-gold" style="font-size:11px;text-decoration:none;">Meta Business Suite</a>
          <a href="https://openart.ai/image/bulk" target="_blank" class="btn btn-dark" style="font-size:11px;text-decoration:none;">OpenArt Bulk Create</a>
          <a href="https://openart.ai/audio/tts" target="_blank" class="btn btn-dark" style="font-size:11px;text-decoration:none;">OpenArt TTS</a>
          <a href="https://www.capcut.com" target="_blank" class="btn btn-dark" style="font-size:11px;text-decoration:none;">CapCut</a>
        </div>
      </div>
    </div>
  </div>
...
<div id="copy-modal" style="display:none;position:fixed;top:0;left:0;width:100%;height:100%;padding:20px;background:rgba(0,0,0,.8);z-index:9999;align-items:center;justify-content:center;">
  <div style="background:var(--dark2);border-radius:10px;padding:20px;width:90%;max-width:500px;">
    ...
    <div style="display:flex;gap:10px;margin-top:12px;">
      ...
      <button id="copy-modal-close" class="btn btn-ghost">Done</button>
      <button id="copy-modal-close2" class="btn btn-ghost" style="display:none;">Done</button>
    </div>
  </div>
</div>

<script src="/tdm/studio.js?v=2" defer></script>
</body>
</html>
'''
