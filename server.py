...
def api_bookkeeping_extract():
    import urllib.request, json as json_lib, re
    ...
    payload = json_lib.dumps({
        ...
        "max_tokens": 4000,
        "system": (
            "You are a bookkeeping assistant. Extract every transaction from this bank statement PDF "
        ...
        "messages": [{
            ...
            "content": [
                ...
                {"type": "text", "text": "Extract all transactions from this bank statement as a JSON array only."}
            ]
        }]
    }).encode("utf-8")
