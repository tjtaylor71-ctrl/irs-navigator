...
PAGE_NO_NAV = {"LoginPage", "ResetPage", "TOSPage", "PrivacyPage", "CovidPenaltyTool", "BookkeepingTool", "ProSignupPage", "IRSApp", "PlanningDashboard", "LetterGenerator", "TranscriptAnalyzer", "ReferralPage", "TaxProPage", "DashboardPage", "PricingPage", "AdminPage", "IRSIntakeWizard", "NavigatorDemo", "WizardDemo", "CovidPenaltyDemo"}
