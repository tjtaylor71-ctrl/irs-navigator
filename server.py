...
# from planning.routes import planning_bp  # re-enable after confirming planning/routes.py is correct

app = Flask(__name__, static_folder="static", static_url_path="/static")
app.secret_key = os.environ.get("SECRET_KEY", "dev-secret-change-in-production")
# app.register_blueprint(planning_bp, url_prefix='/planning')  # re-enable after planning fix
