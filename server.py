...
PLANNING_FORMS = {
    ...
    "energy-improvement-log": ("Energy Credits — Improvement Log", "Log energy-efficiency improvements for tax credit purposes (IRC §179D, §25C, §30D). Record improvement type, date placed in service, contractor name, cost, and expected credit."),
