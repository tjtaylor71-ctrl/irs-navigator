...
PAGE_MID = """</title>
  ...
  <style>
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    #error-display { display:none; padding:24px; color:#dc2626; font-family:monospace; font-size:13px; white-space:pre-wrap; background:#fff1f2; border:2px solid #dc2626; margin:24px; border-radius:8px; }
  </style>
</head>
<body>
