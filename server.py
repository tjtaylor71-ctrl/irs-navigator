...
<body>
  ...
  <style>
    ...
    .irsn-wrap { background: #1a2d5a; border-bottom: 3px solid #7ec11f; padding: 12px 24px; font-family: Georgia, serif; }
    ...
    .irsn-login-btn {
      ...
      border-radius: 20px; transition: all 0.2s; font-family: Georgia, serif;
    }
...
FORM_PAGE_STYLE = """
  body { font-family: Georgia, serif; background: #f8f6f1; margin: 0; padding: 0; color: #333; }
  ...
  input[type=text], input[type=date], input[type=number], textarea, select { width: 100%; box-sizing: border-box; padding: 8px 12px; border: 1px solid #ccc; border-radius: 6px; font-family: Georgia, serif; font-size: 13px; background: #fafafa; }
  ...
  .btn-print { background: #1a2d5a; color: #7ec11f; border: none; padding: 10px 24px; border-radius: 8px; font-family: Georgia, serif; font-size: 14px; font-weight: bold; cursor: pointer; margin-top: 20px; }
...
<style>
  * { box-sizing: border-box; margin: 0; padding: 0; }
  body { font-family: Georgia, serif; background: #f8f6f1; min-height: 100vh; display: flex; flex-direction: column; }
  .header { background: #1a2d5a; border-bottom: 3px solid #7ec11f; padding: 14px 24px; }
  ...
  .login-btn { display: inline-block; padding: 13px 32px; background: #1a2d5a; color: #7ec11f; border: 2px solid #7ec11f; border-radius: 8px; font-family: Georgia, serif; font-size: 15px; font-weight: bold; text-decoration: none; transition: background 0.2s; }
