      ...
      fetch('/api/me', { credentials: 'include' })
        ...
        .then(function(user) {
          ...
          var html = '<div id="irs-pilot-nav"><div class="irsn-wrap"><div class="irsn-inner">' +
            ...
            (user.loggedIn
              ? '<div class="irsn-menu" id="irsn-menu"><button class="irsn-btn" onclick="document.getElementById(\'irsn-menu\').classList.toggle(\'open\')">' +
                '<div class="irsn-avatar">' + initials + '</div>' +
