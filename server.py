...
<style>
  ...
  <p style="margin-top:24px;font-size:13px">Need help? <a href="https://www.calendly.com/taylor-tax-financial/tax-help" style="color:#1a1a2e">Schedule a free consultation</a></p>
</div></body></html>"""
    return Response(html, mimetype="text/html")
