...
- If you don't know something, say so and direct them to info@taylortaxandfinancial.com`;
  ...
  return /* @__PURE__ */ React.createElement("div", { style: { position: "fixed", bottom: 24, right: 24, zIndex: 9999, fontFamily: "Georgia, serif" } }, open && /* @__PURE__ */ React.createElement("div", { style: {
    position: "absolute",
    bottom: 72,
    right: 0,
    width: 340,
    ...
    "\u2192"
  )), /* @__PURE__ */ React.createElement("div", { style: { padding: "0 14px 12px", fontSize: 10, color: "#aaa", textAlign: "center" } }, "For complex IRS issues, consult a licensed professional.")), /* @__PURE__ */ React.createElement(
    "button",
    {
      onClick: () => setOpen((o) => !o),
      style: {
