...
function WizardButton() {
  return (
    <a href="/wizard" target="_blank" rel="noopener noreferrer"
      ...
      onMouseEnter={e => { e.currentTarget.style.background = "#c8a96e"; e.currentTarget.style.color = "#1a1a2e"; }}
      onMouseLeave={e => { e.currentTarget.style.background = "#1a1a2e"; e.currentTarget.style.color = "#c8a96e"; }}>
...
export default function IRSApp() {
  ...
  return (
    <div style={{ fontFamily: "'Georgia', serif", minHeight: "100vh", background: "#f8f6f1", color: "#1a1a2e" }}>
      {/* Header */}
      <div style={{ background: "#1a1a2e", padding: "16px 24px", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
        <div style={{ display: "flex", alignItems: "center", gap: 12, cursor: "pointer" }} onClick={() => { setScreen("home"); setSelectedNotice(null); setSelectedSituation(null); }}>
          <div style={{ width: 36, height: 36, background: "#c8a96e", borderRadius: 8, display: "flex", alignItems: "center", justifyContent: "center", fontSize: 18 }}>⚖️</div>
          <div>
            <div style={{ color: "#fff", fontWeight: "bold", fontSize: 16, letterSpacing: 0.5 }}>IRS Navigator</div>
            <div style={{ color: "#c8a96e", fontSize: 11, letterSpacing: 1 }}>TAXPAYER SELF-HELP</div>
          </div>
        </div>
        {screen !== "home" && (
      ...
      <div style={{ maxWidth: 720, margin: "0 auto", padding: "24px 16px" }}>
        ...
        {screen === "home" && (
          <div>
            <div style={{ textAlign: "center", padding: "32px 0 28px" }}>
              <h1 style={{ fontSize: 28, fontWeight: "bold", margin: "0 0 10px", color: "#1a1a2e" }}>Don't Face the IRS Alone</h1>
              <p style={{ fontSize: 16, color: "#555", margin: 0 }}>Plain-English guidance for real IRS situations — no tax jargon, no guesswork.</p>
            </div>
            ...
            <div style={{ display: "grid", gap: 16, gridTemplateColumns: "1fr 1fr" }}>
              <div onClick={() => setScreen("notice-lookup")}
                ...
                <div style={{ fontWeight: "bold", fontSize: 17, marginBottom: 8 }}>I Got an IRS Letter</div>
                <div style={{ color: "#666", fontSize: 14, lineHeight: 1.5 }}>Find out what your notice means and exactly what to do next.</div>
              </div>
              ...
              <div onClick={() => setScreen("situations")}
                ...
                onMouseLeave={e => e.currentTarget.style.borderColor = "#e8e4dc"}>
                <div style={{ fontSize: 32, marginBottom: 12 }}>🧭</div>
                <div style={{ fontWeight: "bold", fontSize: 17, marginBottom: 8 }}>I Have a Tax Problem</div>
                <div style={{ color: "#666", fontSize: 14, lineHeight: 1.5 }}>Describe your situation and get a clear path forward.</div>
              </div>
            </div>

            {/* Wizard CTA */}
            <div style={{ background: "#fff", border: "2px solid #c8a96e", borderRadius: 12, padding: 24, marginTop: 16, display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: 16 }}>
              <div>
                <div style={{ fontWeight: "bold", fontSize: 16, color: "#1a1a2e", marginBottom: 4 }}>📋 Ready to complete your IRS financial forms?</div>
                <div style={{ color: "#666", fontSize: 14 }}>The intake wizard calculates your options and auto-fills Forms 433-F, 433-A, 433-A OIC, and Form 656.</div>
              </div>
              <WizardButton />
            </div>

            <div style={{ background: "#1a1a2e", borderRadius: 12, padding: 20, marginTop: 20, display: "flex", gap: 16, alignItems: "center" }}>
              <div style={{ fontSize: 28 }}>💡</div>
              <div>
                <div style={{ color: "#c8a96e", fontWeight: "bold", fontSize: 14, marginBottom: 4 }}>PRO TIP</div>
                <div style={{ color: "#e8e4dc", fontSize: 14, lineHeight: 1.6 }}>The IRS wants to resolve issues — not chase you. Responding to any notice, even just to say "I need more time," is always better than silence.</div>
              </div>
            </div>
          </div>
        )}
          ...
          <div>
            ...
            <div style={{ marginBottom: 8 }}>
              <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 12 }}>
                <span style={{ fontWeight: "bold", color: "#1a1a2e", fontSize: 14, letterSpacing: 0.5 }}>📋 COLLECTION NOTICES</span>
            ...
            <div style={{ marginTop: 28 }}>
              <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 12 }}>
                <span style={{ fontWeight: "bold", color: "#1a1a2e", fontSize: 14, letterSpacing: 0.5 }}>🔍 AUDIT & EXAMINATION NOTICES</span>
              </div>
        ...
        {screen === "notice-detail" && selectedNotice && sev && (
          <div>
            ...
            <div style={{ background: sev.bg, border: `2px solid ${sev.border}`, borderRadius: 12, padding: 20, marginBottom: 20 }}>
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
                <div>
                  ...
                  <div style={{ fontWeight: "bold", fontSize: 20, color: "#1a1a2e" }}>{selectedNotice.title.split("—")[1]?.trim()}</div>
                </div>
              ...
              <section style={{ background: "#fff", borderRadius: 12, padding: 20, marginBottom: 16, border: "1px solid #e8e4dc" }}>
                ...
                {selectedNotice.commonCauses.map((c, i) => (
                  <div key={i} style={{ display: "flex", gap: 10, marginBottom: 8, fontSize: 14, color: "#444" }}>
                    <span style={{ color: "#c8a96e", fontWeight: "bold" }}>•</span> {c}
                  </div>
                ))}
              </section>
            )}
            ...
            <section style={{ background: "#1a1a2e", borderRadius: 12, padding: 20 }}>
              <div style={{ color: "#c8a96e", fontWeight: "bold", fontSize: 13, letterSpacing: 1, marginBottom: 8 }}>💡 PRO TIP FROM AN ENROLLED AGENT</div>
              ...
              {situationPaths.map(s => (
                <div key={s.id} onClick={() => setSelectedSituation(s)}
                  ...
                  <div style={{ display: "flex", gap: 14, alignItems: "flex-start" }}>
                    ...
                    <div>
                      <div style={{ fontWeight: "bold", fontSize: 17, marginBottom: 4 }}>{s.title}</div>
                      <div style={{ color: "#666", fontSize: 14 }}>{s.description}</div>
                    </div>
                  </div>
                </div>
              ))}
          ...
          <div>
            ...
            {selectedSituation.levySituation && (
              <div>
                ...
                <div style={{ marginBottom: 24 }}>
                  <div style={{ fontWeight: "bold", fontSize: 15, color: "#1a1a2e", marginBottom: 12, textAlign: "center" }}>⚖️ Lien vs. Levy — Know the Difference</div>
            ...
            {selectedSituation.freshStartWarning && (
              <div style={{ background: "#1a1a2e", borderRadius: 12, padding: 20, marginBottom: 24 }}>
                <div style={{ color: "#c8a96e", fontWeight: "bold", fontSize: 13, letterSpacing: 0.5, marginBottom: 10 }}>⚠️ MYTH BUSTER — THE "FRESH START INITIATIVE"</div>
                <p style={{ color: "#e8e4dc", fontSize: 14, lineHeight: 1.75, margin: "0 0 10px" }}>
                  You may have heard advertisements promising a "Fresh Start" that will wipe out your tax debt. <strong style={{ color: "#c8a96e" }}>This is misleading.</strong> There is no active IRS program that simply forgives or erases tax balances.
                </p>
                <p style={{ color: "#e8e4dc", fontSize: 14, lineHeight: 1.75, margin: "0 0 10px" }}>
                ...
                <p style={{ color: "#c8a96e", fontSize: 14, lineHeight: 1.75, margin: 0, fontWeight: "bold" }}>
            ...
            <div style={{ display: "grid", gap: 16 }}>
              {selectedSituation.options.map((opt, i) => (
                <div key={i} style={{
                  ...
                  <div style={{ fontWeight: "bold", fontSize: 16, marginBottom: 10, color: "#1a1a2e" }}>{opt.title}</div>
                  ...
                  <div style={{ color: "#555", fontSize: 14, lineHeight: 1.75, marginBottom: 12 }}>
                    {opt.desc.split("\n").map((line, j) => {
                      if (line.startsWith("•")) {
                        ...
                        return <div key={j} style={{ fontWeight: "bold", marginTop: 10, marginBottom: 4, color: "#1a1a2e" }}>{line}</div>;
                      } else if (line === "") {
