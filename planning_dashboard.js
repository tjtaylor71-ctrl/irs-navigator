...
function PlanningInput({ initialValues = {}, onSave, onCalculate, saving, calculating }) {
  ...
  const MoneyField = ({ id, label: lbl, hint: hnt, value }) => /* @__PURE__ */ React.createElement("div", { style: { marginBottom: 14 } }, /* @__PURE__ */ React.createElement("label", { htmlFor: id, style: label }, lbl, hnt && /* @__PURE__ */ React.createElement("span", { style: hint }, hnt)), /* @__PURE__ */ React.createElement("div", { style: { position: "relative" } }, /* @__PURE__ */ React.createElement("span", { style: prefix }, "$"), /* @__PURE__ */ React.createElement(
    "input",
    {
      id,
      name: id,
  ...
  return /* @__PURE__ */ React.createElement("div", { style: {
  ...
  )), /* @__PURE__ */ React.createElement("fieldset", { style: fieldset }, /* @__PURE__ */ React.createElement("legend", { style: legend }, "Income"), /* @__PURE__ */ React.createElement(MoneyField, { id: "income_w2", label: "W-2 Wages", value: form.income_w2 }), /* @__PURE__ */ React.createElement(
    MoneyField,
    {
      id: "income_se",
      label: "Self-Employment / Business Income",
      hint: "Gross \u2014 before expenses",
    ...
    MoneyField,
    {
      id: "income_other",
      label: "Other Income",
      hint: "Interest, dividends, 1099-R, rental",
    ...
    MoneyField,
    {
      ...
      hint: "From pay stubs so far this year",
    ...
    MoneyField,
    {
      ...
      hint: "1040-ES payments already made",
...
function PlanningDashboard() {
  ...
  } }, /* @__PURE__ */ React.createElement("div", { style: { textAlign: "center", color: "#888" } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 32, marginBottom: 12 } }, "\u{1F4CA}"), "Loading your tax planning session..."));
