...
function UsageCounter() {
  var _c = useState2(null); var count = _c[0]; var setCount = _c[1];
  useEffect2(function() {
    fetch("/api/public/user-count")
      .then(function(r){ return r.json(); })
      .then(function(d){ if (d.ok && d.display) setCount(d.count); })
      .catch(function(){});
  }, []);
  if (!count) return null;
  return /* @__PURE__ */ React.createElement("div", { style: { textAlign:"center", padding:"16px 0 8px", borderTop:"1px solid #e8e4dc" } },
    /* @__PURE__ */ React.createElement("span", { style: { background:"#f0fdf4", border:"1px solid #7ec11f", borderRadius:20, padding:"5px 16px", fontSize:13, color:"#15803d", fontWeight:"bold" } },
      "\u2705 " + count.toLocaleString() + " taxpayers helped and counting"
    )
  );
}
...
function SeeItInAction() {
  var screens = [
    {
      label: "9-step financial intake wizard",
      title: "Step 4 of 9 \u2014 Income & Employment",
      desc: "Walks you through your financial picture using plain-English questions. No tax jargon.",
      icon: "\uD83D\uDCCB",
      preview: [
        { text: "W-2 employee (currently employed)", sel: true },
        { text: "Self-employed / 1099 contractor", sel: false },
        { text: "Unemployed / receiving benefits", sel: false },
      ]
    },
    {
      label: "Auto-filled Form 433-F",
      title: "Collection Information Statement \u2014 Pre-Filled",
      desc: "Your answers auto-populate the IRS form using National and Local Standards. No math required.",
      icon: "\uD83D\uDCDD",
      fields: [
        { label: "Monthly net wages", val: "$4,820", filled: true },
        { label: "Housing (Local Standard)", val: "$1,940", filled: true },
        { label: "Food / Clothing (National)", val: "$849", filled: true },
      ]
    },
    {
      label: "Live RCP Calculator",
      title: "Offer in Compromise Eligibility",
      desc: "Calculates your Reasonable Collection Potential in real time \u2014 the number that determines if you qualify for an OIC.",
      icon: "\uD83E\uDDEE",
      rcp: { balance: "$38,400", rcp: "$19,176", verdict: "You may qualify for an OIC \u2014 your RCP is below your total balance." }
    }
  ];
  var _a = useState2(0); var active = _a[0]; var setActive = _a[1];
  var scr = screens[active];
  var s = {
    wrap: { background:"#fff", border:"1px solid #e8e4dc", borderRadius:14, padding:"20px", marginBottom:16 },
    tabs: { display:"flex", gap:8, marginBottom:16, flexWrap:"wrap" },
    tab: { fontSize:12, padding:"5px 12px", borderRadius:20, cursor:"pointer", border:"1px solid #e8e4dc", background:"transparent", color:"#888", fontFamily:"'DM Sans',sans-serif" },
    tabActive: { fontSize:12, padding:"5px 12px", borderRadius:20, cursor:"pointer", border:"1px solid #1a2d5a", background:"#1a2d5a", color:"#7ec11f", fontFamily:"'DM Sans',sans-serif", fontWeight:"bold" },
    mockup: { background:"#f8f6f1", border:"1px solid #e8e4dc", borderRadius:10, overflow:"hidden" },
    topbar: { background:"#1a2d5a", padding:"8px 14px", display:"flex", alignItems:"center", gap:6 },
    dot: { width:7, height:7, borderRadius:"50%" },
    body: { padding:"14px" },
    opt: { border:"1px solid #e8e4dc", borderRadius:7, padding:"8px 12px", marginBottom:5, fontSize:13, color:"#666" },
    optSel: { border:"1.5px solid #1a2d5a", borderRadius:7, padding:"8px 12px", marginBottom:5, fontSize:13, color:"#1a2d5a", background:"#f0f7ff", fontWeight:"bold" },
    field: { background:"#fff", border:"1px solid #e8e4dc", borderRadius:7, padding:"8px 12px", marginBottom:5, display:"flex", justifyContent:"space-between", fontSize:13 },
    fieldFilled: { background:"#f0fdf4", border:"1px solid #7ec11f", borderRadius:7, padding:"8px 12px", marginBottom:5, display:"flex", justifyContent:"space-between", fontSize:13 },
  };
  return /* @__PURE__ */ React.createElement("div", { style: s.wrap },
    /* @__PURE__ */ React.createElement("div", { style: { marginBottom:12 } },
      /* @__PURE__ */ React.createElement("div", { style: { fontSize:11, fontWeight:"bold", color:"#7ec11f", letterSpacing:1.5, marginBottom:4 } }, "SEE IT IN ACTION"),
      /* @__PURE__ */ React.createElement("div", { style: { fontWeight:"bold", fontSize:16, color:"#1a2d5a" } }, "What the tool actually shows you")
    ),
    /* @__PURE__ */ React.createElement("div", { style: s.tabs },
      screens.map(function(sc, i) {
        return /* @__PURE__ */ React.createElement("button", { key:i, style: i===active ? s.tabActive : s.tab, onClick:function(){setActive(i);} }, sc.icon + " " + sc.label);
      })
    ),
    /* @__PURE__ */ React.createElement("div", { style: s.mockup },
      /* @__PURE__ */ React.createElement("div", { style: s.topbar },
        /* @__PURE__ */ React.createElement("div", { style: { ...s.dot, background:"#ff5f57" } }),
        /* @__PURE__ */ React.createElement("div", { style: { ...s.dot, background:"#ffbd2e" } }),
        /* @__PURE__ */ React.createElement("div", { style: { ...s.dot, background:"#28c840" } }),
        /* @__PURE__ */ React.createElement("span", { style: { color:"#7ec11f", fontSize:11, marginLeft:6 } }, "IRS Pilot \u2014 " + scr.title)
      ),
      /* @__PURE__ */ React.createElement("div", { style: s.body },
        /* @__PURE__ */ React.createElement("div", { style: { fontSize:12, color:"#888", marginBottom:10 } }, scr.desc),
        scr.preview && scr.preview.map(function(opt, i) {
          return /* @__PURE__ */ React.createElement("div", { key:i, style: opt.sel ? s.optSel : s.opt }, (opt.sel ? "\u25C9 " : "\u25CB ") + opt.text);
        }),
        scr.fields && scr.fields.map(function(f, i) {
          return /* @__PURE__ */ React.createElement("div", { key:i, style: f.filled ? s.fieldFilled : s.field },
            /* @__PURE__ */ React.createElement("span", { style: { color:"#888" } }, f.label),
            /* @__PURE__ */ React.createElement("span", { style: { fontWeight:"bold", color: f.filled ? "#15803d" : "#1a2d5a" } }, f.val + (f.filled ? " \u2713" : ""))
          );
        }),
        scr.rcp && /* @__PURE__ */ React.createElement("div", null,
          /* @__PURE__ */ React.createElement("div", { style: s.field },
            /* @__PURE__ */ React.createElement("span", { style:{ color:"#888" } }, "Total balance owed"),
            /* @__PURE__ */ React.createElement("span", { style:{ fontWeight:"bold" } }, scr.rcp.balance)
          ),
          /* @__PURE__ */ React.createElement("div", { style: s.fieldFilled },
            /* @__PURE__ */ React.createElement("span", { style:{ color:"#15803d" } }, "Your RCP (minimum OIC offer)"),
            /* @__PURE__ */ React.createElement("span", { style:{ fontWeight:"bold", color:"#15803d" } }, scr.rcp.rcp + " \u2713")
          ),
          /* @__PURE__ */ React.createElement("div", { style:{ background:"#f0fdf4", border:"1px solid #7ec11f", borderRadius:7, padding:"10px 12px", marginTop:6, fontSize:13, color:"#15803d" } }, scr.rcp.verdict)
        )
      )
    ),
    /* @__PURE__ */ React.createElement("div", { style:{ textAlign:"center", marginTop:12 } },
      /* @__PURE__ */ React.createElement("a", { href:"/pricing", style:{ background:"#1a2d5a", color:"#7ec11f", border:"2px solid #7ec11f", borderRadius:8, padding:"10px 22px", textDecoration:"none", fontWeight:"bold", fontSize:14 } }, "Get Full Access \u2014 from $59 \u2192")
    )
  );
}
...
function IRSPilotNav(props) {
  ...
  var _pd = React.useState(false); var profileDismissed = _pd[0]; var setProfileDismissed = _pd[1];
...
function PartnerProfilePrompt({ user, onDismiss }) {
  var _s = useState2(false); var saving = _s[0]; var setSaving = _s[1];
  var _e = useState2(""); var error = _e[0]; var setError = _e[1];
  var _n = useState2(""); var name = _n[0]; var setName = _n[1];
  var _f = useState2(""); var firm = _f[0]; var setFirm = _f[1];
  var _c = useState2(""); var credential = _c[0]; var setCredential = _c[1];
  var _p = useState2(""); var phone = _p[0]; var setPhone = _p[1];
  var _w = useState2(""); var website = _w[0]; var setWebsite = _w[1];
  var _open = useState2(false); var open = _open[0]; var setOpen = _open[1];

  if (!open) return /* @__PURE__ */ React.createElement("div", {
    style: { background:"#fef3c7", borderBottom:"2px solid #f59e0b", padding:"10px 20px", display:"flex", alignItems:"center", justifyContent:"space-between", gap:12, flexWrap:"wrap" }
  },
    /* @__PURE__ */ React.createElement("div", { style:{ fontSize:14, color:"#92400e" } },
      "\uD83D\uDC4B Welcome, partner! ",
      /* @__PURE__ */ React.createElement("strong", null, "Complete your profile"),
      " so we know who you are and can personalize your outreach."
    ),
    /* @__PURE__ */ React.createElement("div", { style:{ display:"flex", gap:8 } },
      /* @__PURE__ */ React.createElement("button", {
        onClick: function(){ setOpen(true); },
        style:{ background:"#f59e0b", color:"#fff", border:"none", borderRadius:7, padding:"7px 16px", fontWeight:"bold", fontSize:13, cursor:"pointer", fontFamily:"'DM Sans',sans-serif" }
      }, "Complete Profile \u2192"),
      /* @__PURE__ */ React.createElement("button", {
        onClick: onDismiss,
        style:{ background:"transparent", color:"#92400e", border:"1px solid #f59e0b", borderRadius:7, padding:"7px 12px", fontSize:12, cursor:"pointer", fontFamily:"'DM Sans',sans-serif" }
      }, "Later")
    )
  );

  function handleSave() {
    if (!name.trim() || !firm.trim()) { setError("Name and firm are required."); return; }
    setSaving(true); setError("");
    fetch("/api/referral/profile", {
      method:"POST", credentials:"include",
      headers:{"Content-Type":"application/json"},
      body: JSON.stringify({ name: name, firm: firm, credential: credential, phone: phone, website: website })
    })
    .then(function(r){ return r.json(); })
    .then(function(d){
      setSaving(false);
    ...
    .catch(function(){ setSaving(false); setError("Network error. Please try again."); });
  }

  var inp = { width:"100%", border:"1px solid #e8e4dc", borderRadius:8, padding:"9px 12px", fontSize:14, fontFamily:"'DM Sans',sans-serif", marginBottom:12, boxSizing:"border-box" };
  var lbl = { display:"block", fontSize:12, fontWeight:"bold", color:"#1a2d5a", marginBottom:4, textTransform:"uppercase", letterSpacing:0.4 };

  return /* @__PURE__ */ React.createElement("div", { style:{ position:"fixed", inset:0, background:"rgba(0,0,0,0.5)", zIndex:9000, display:"flex", alignItems:"center", justifyContent:"center", padding:16 } },
    /* @__PURE__ */ React.createElement("div", { style:{ background:"#fff", borderRadius:14, padding:"28px 32px", maxWidth:480, width:"100%", boxShadow:"0 20px 60px rgba(0,0,0,0.2)" } },
      /* @__PURE__ */ React.createElement("div", { style:{ fontWeight:"bold", fontSize:18, color:"#1a2d5a", marginBottom:4 } }, "Complete Your Partner Profile"),
      /* @__PURE__ */ React.createElement("p", { style:{ fontSize:14, color:"#888", marginBottom:20, lineHeight:1.6 } },
        "This helps us personalize your outreach and ensures your referral commissions are sent to the right person."
      ),
      React.createElement("label", { style: lbl }, "Full Name *"),
      React.createElement("input", { style: inp, placeholder:"Tyrone J. Taylor", value: name, onChange: function(e){ setName(e.target.value); } }),
      React.createElement("label", { style: lbl }, "Firm Name *"),
      React.createElement("input", { style: inp, placeholder:"Taylor Tax and Financial Consulting", value: firm, onChange: function(e){ setFirm(e.target.value); } }),
      React.createElement("label", { style: lbl }, "Credential (EA, CPA, etc.)"),
      React.createElement("input", { style: inp, placeholder:"EA, CPA, NTPI Fellow...", value: credential, onChange: function(e){ setCredential(e.target.value); } }),
      React.createElement("label", { style: lbl }, "Phone Number"),
      React.createElement("input", { style: inp, placeholder:"(615) 555-0100", value: phone, onChange: function(e){ setPhone(e.target.value); } }),
      React.createElement("label", { style: lbl }, "Website"),
      React.createElement("input", { style: inp, placeholder:"https://yourfirm.com", value: website, onChange: function(e){ setWebsite(e.target.value); } }),
      ...
      React.createElement("div", { style:{ display:"flex", gap:10 } },
        React.createElement("button", { onClick: handleSave, disabled: saving, style:{ flex:1, background:"#1a2d5a", color:"#7ec11f", border:"2px solid #7ec11f", borderRadius:8, padding:"11px", fontFamily:"'DM Sans',sans-serif", fontWeight:"bold", fontSize:14, cursor:"pointer" } },
          saving ? "Saving\u2026" : "Save Profile \u2192"
        ),
        React.createElement("button", { onClick: function(){ setOpen(false); onDismiss(); }, style:{ background:"transparent", color:"#aaa", border:"1px solid #e8e4dc", borderRadius:8, padding:"11px 16px", fontFamily:"'DM Sans',sans-serif", fontSize:13, cursor:"pointer" } }, "Later")
      )
    )
  );
}
...
function IRSApp() {
  ...
  return /* @__PURE__ */ React.createElement("div", { style: { fontFamily: "'Georgia', serif", minHeight: "100vh", background: "#f8f6f1", color: "#1a2d5a" } }, /* @__PURE__ */ React.createElement(IRSPilotNav, { subtitle: "TAXPAYER SELF-HELP" }), /* @__PURE__ */ React.createElement("div", { style: { maxWidth: 720, margin: "0 auto", padding: "24px 16px" } }, screen === "home" && /* @__PURE__ */ React.createElement("div", null,

    /* COVID Penalty Relief Banner */
    (() => {
      var bannerExpiry = new Date("2026-07-11T23:59:59");
      var now = new Date();
      if (now > bannerExpiry) return null;
      var daysLeft = Math.max(0, Math.ceil((bannerExpiry - now) / (1000*60*60*24)));
      return /* @__PURE__ */ React.createElement("div", { style: { background: "linear-gradient(135deg, #7f1d1d 0%, #1a2d5a 100%)", borderRadius: 12, padding: "18px 22px", marginBottom: 20, display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: 14, border: "1.5px solid #dc2626" } },
        /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 14 } },
          /* @__PURE__ */ React.createElement("div", { style: { width: 42, height: 42, background: "rgba(220,38,38,0.2)", border: "1.5px solid #dc2626", borderRadius: 10, display: "flex", alignItems: "center", justifyContent: "center", fontSize: 20, flexShrink: 0 } }, "\uD83D\uDEE1\uFE0F"),
          /* @__PURE__ */ React.createElement("div", null,
            /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 8, marginBottom: 3 } },
              /* @__PURE__ */ React.createElement("div", { style: { fontWeight: "bold", fontSize: 15, color: "#fff" } }, "NEW: COVID Penalty Relief Tool"),
              /* @__PURE__ */ React.createElement("div", { style: { background: "#dc2626", color: "#fff", fontSize: 9, fontWeight: "bold", padding: "2px 7px", borderRadius: 10, letterSpacing: 0.5 } }, "NEW")
            ),
            /* @__PURE__ */ React.createElement("div", { style: { color: "#fca5a5", fontSize: 13, lineHeight: 1.5 } },
              "Were you hit with IRS penalties during COVID? Many were assessed without required supervisory approval. Upload your transcript \u2014 we\'ll identify what can be challenged and generate the letter."
            ),
            /* @__PURE__ */ React.createElement("div", { style: { color: "#888", fontSize: 11, marginTop: 4 } }, "Submission deadline July 10, 2026 \u00b7 " + daysLeft + " days remaining \u00b7 $99 one-time")
          )
        ),
        /* @__PURE__ */ React.createElement("a", { href: "/pricing", style: { background: "#dc2626", color: "#fff", border: "2px solid #fca5a5", borderRadius: 8, padding: "10px 20px", fontFamily: "\'DM Sans\',sans-serif", fontWeight: "bold", fontSize: 13, textDecoration: "none", flexShrink: 0, whiteSpace: "nowrap" } }, "Learn More \u2192")
      );
    })(),

    /* @__PURE__ */ React.createElement("div", { style: { textAlign: "center", padding: "36px 16px 28px" } }, /* @__PURE__ */ React.createElement("div", { style: { display: "inline-block", background: "#1a2d5a", color: "#7ec11f", fontSize: 11, fontWeight: "bold", letterSpacing: 1, padding: "4px 14px", borderRadius: 20, marginBottom: 14 } }, "TAXPAYER SELF-HELP TOOL"), /* @__PURE__ */ React.createElement("h1", { style: { fontSize: 30, fontWeight: "bold", margin: "0 0 8px", color: "#1a2d5a", lineHeight: 1.2 } }, "Don't Face the IRS Alone"), /* @__PURE__ */ React.createElement("p", { style: { fontSize: 13, fontWeight: "bold", color: "#7ec11f", letterSpacing: 1.2, textTransform: "uppercase", margin: "0 0 10px" } }, "IRS Notice Help & Tax Problem Guide \u2014 Built by a Licensed EA"), /* @__PURE__ */ React.createElement("p", { style: { fontSize: 15, color: "#555", margin: "0 auto", maxWidth: 480, lineHeight: 1.7 } }, "Plain-English guidance for real IRS situations \u2014 no tax jargon, no attorneys required.")), /* @__PURE__ */ React.createElement("div", { style: { marginBottom: 12 } },
  /* Primary CTA - full width */
  /* @__PURE__ */ React.createElement("div", {
    onClick: () => setScreen("notice-lookup"),
    style: { background: "#1a2d5a", border: "2px solid #7ec11f", borderRadius: 14, padding: "22px 20px", cursor: "pointer", marginBottom: 12, display: "flex", alignItems: "center", gap: 16 },
    onMouseEnter: (e) => { e.currentTarget.style.background = "#243d7a"; },
    onMouseLeave: (e) => { e.currentTarget.style.background = "#1a2d5a"; }
  },
    /* @__PURE__ */ React.createElement("div", { style: { width: 48, height: 48, background: "#7ec11f", borderRadius: 12, display: "flex", alignItems: "center", justifyContent: "center", fontSize: 22, flexShrink: 0 } }, "\uD83D\uDCEC"),
    /* @__PURE__ */ React.createElement("div", { style: { flex: 1 } },
      /* @__PURE__ */ React.createElement("div", { style: { fontWeight: "bold", fontSize: 17, color: "#fff", marginBottom: 3 } }, "I Got an IRS Letter"),
      /* @__PURE__ */ React.createElement("div", { style: { color: "#cce8a0", fontSize: 13, lineHeight: 1.5 } }, "Explains your notice in plain English and shows exactly what to do next \u2014 no jargon.")
    ),
    /* @__PURE__ */ React.createElement("div", { style: { color: "#7ec11f", fontSize: 15, fontWeight: "bold", flexShrink: 0 } }, "Look Up My Notice \u2192")
  ),
  /* Secondary cards - 2 col */
  /* @__PURE__ */ React.createElement("div", { style: { display: "grid", gap: 12, gridTemplateColumns: "1fr 1fr" } },
    /* @__PURE__ */ React.createElement("div", {
      onClick: () => setScreen("situations"),
      style: { background: "#fff", border: "2px solid #e8e4dc", borderRadius: 14, padding: "18px 16px", cursor: "pointer", transition: "all 0.2s" },
      ...
      /* @__PURE__ */ React.createElement("div", { style: { fontSize: 22, marginBottom: 8 } }, "\u26A1"),
      /* @__PURE__ */ React.createElement("div", { style: { fontWeight: "bold", fontSize: 15, marginBottom: 4, color: "#1a2d5a" } }, "I Have a Tax Problem"),
      /* @__PURE__ */ React.createElement("div", { style: { color: "#666", fontSize: 12, lineHeight: 1.5, marginBottom: 10 } }, "Identify your situation and find a clear path forward."),
    ...
    /* @__PURE__ */ React.createElement("div", {
      ...
      /* @__PURE__ */ React.createElement("div", { style: { fontSize: 22, marginBottom: 8 } }, "\uD83D\uDCB3"),
      /* @__PURE__ */ React.createElement("div", { style: { fontWeight: "bold", fontSize: 15, marginBottom: 4, color: "#1a2d5a" } }, "Pricing & Access"),
      /* @__PURE__ */ React.createElement("div", { style: { color: "#666", fontSize: 12, lineHeight: 1.5, marginBottom: 10 } }, "Navigator, Wizard, Bundle. Starts at $59."),
      /* @__PURE__ */ React.createElement("div", { style: { color: "#f59e0b", fontSize: 13, fontWeight: "bold" } }, "View Plans \u2192")
    )
  ),
  /* Tax Pro demoted to text link */
  /* @__PURE__ */ React.createElement("div", {
    onClick: function(){ window.location.href="/taxpro"; },
    style: { background:"#fff", border:"2px solid #e8e4dc", borderRadius:14, padding:"16px 18px", cursor:"pointer", transition:"all 0.2s", marginTop:4 },
    onMouseEnter: function(e){ e.currentTarget.style.borderColor="#7ec11f"; e.currentTarget.style.boxShadow="0 4px 16px rgba(126,193,31,0.15)"; },
    onMouseLeave: function(e){ e.currentTarget.style.borderColor="#e8e4dc"; e.currentTarget.style.boxShadow="none"; }
  },
    /* @__PURE__ */ React.createElement("div", { style:{ display:"flex", alignItems:"center", justifyContent:"space-between" } },
      /* @__PURE__ */ React.createElement("div", { style:{ display:"flex", alignItems:"center", gap:12 } },
        ...
        /* @__PURE__ */ React.createElement("div", null,
          /* @__PURE__ */ React.createElement("div", { style:{ fontWeight:"bold", fontSize:15, color:"#1a2d5a", marginBottom:2 } }, "Tax Professionals"),
          /* @__PURE__ */ React.createElement("div", { style:{ fontSize:12, color:"#888" } }, "Refer clients or subscribe as a Pro partner")
        )
      ),
      /* @__PURE__ */ React.createElement("div", { style:{ color:"#7ec11f", fontSize:13, fontWeight:"bold" } }, "Partner Options \u2192")
    )
  )
), /* @__PURE__ */ React.createElement("div", { style: { textAlign: "center", padding: "8px 0 16px", color: "#888", fontSize: 13 } }, "\uD83D\uDD12 Secure checkout \u00b7 We never sell your data \u00b7 24-hour money-back guarantee \u00b7 7-day access, cancel anytime"), /* @__PURE__ */ React.createElement("div", { style: { background: "#fff", borderRadius: 14, border: "1px solid #e8e4dc", padding: "16px 18px", marginBottom: 12 } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 11, fontWeight: "bold", color: "#1a2d5a", letterSpacing: 0.5, marginBottom: 12 } }, "COMMON SITUATIONS"), /* @__PURE__ */ React.createElement("div", { style: { display: "grid", gap: 8 } }, [
    ...
    "a",
    {
      ...
      target: "_blank",
      rel: "noopener noreferrer",
      style: { background: "#7ec11f", color: "#1a2d5a", fontSize: 12, fontWeight: "bold", padding: "6px 14px", borderRadius: 6, textDecoration: "none", fontFamily: "'DM Sans',sans-serif", flexShrink: 0 }
    },
    "Schedule a Call \u2192"
    ...
    "input",
    {
      ...
      style: { flex: 1, padding: "11px 14px", borderRadius: 8, border: "1.5px solid #ddd", fontSize: 15, outline: "none", fontFamily: "'DM Sans',sans-serif", color: "#1a2d5a" }
    }
  ), /* @__PURE__ */ React.createElement(
    "button",
    {
      onClick: handleNoticeSearch,
      style: { background: "#1a2d5a", color: "#7ec11f", border: "2px solid #7ec11f", borderRadius: 8, padding: "10px 20px", cursor: "pointer", fontWeight: "bold", fontSize: 14, fontFamily: "'DM Sans',sans-serif" }
    },
    "Look Up \u2192"
  ...
  )))), screen === "situations" && selectedSituation && /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("button", { onClick: () => setSelectedSituation(null), style: { background: "none", border: "none", color: "#888", cursor: "pointer", marginBottom: 16, fontSize: 14 } }, "\u2190 Back to situations"), /* @__PURE__ */ React.createElement("h2", { style: { fontSize: 22, fontWeight: "bold", marginBottom: 6 } }, selectedSituation.icon, " ", selectedSituation.title), /* @__PURE__ */ React.createElement("p", { style: { color: "#666", marginBottom: selectedSituation.alert || selectedSituation.freshStartWarning || selectedSituation.levySituation ? 16 : 24 } }, selectedSituation.description), /* @__PURE__ */ React.createElement("div", { style: { background: "#fff", border: "2px solid #7ec11f", borderRadius: 14, padding: "24px 22px", marginBottom: 8 } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 28, marginBottom: 10 } }, "\uD83E\uDDED"), /* @__PURE__ */ React.createElement("div", { style: { fontWeight: "bold", fontSize: 17, color: "#1a2d5a", marginBottom: 8 } }, "We've identified your situation. Here's how to resolve it."), /* @__PURE__ */ React.createElement("p", { style: { color: "#555", fontSize: 14, lineHeight: 1.7, marginBottom: 18 } }, "Navigator walks you through every option available for this exact situation \u2014 payment plans, Offer in Compromise eligibility, Currently Not Collectible status, and the specific forms and deadlines that apply to you \u2014 personalized to your numbers."), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 10, flexWrap: "wrap" } }, /* @__PURE__ */ React.createElement("a", { href: "/demo-navigator", style: { background: "transparent", color: "#1a2d5a", border: "2px solid #1a2d5a", borderRadius: 8, padding: "11px 22px", textDecoration: "none", fontWeight: "bold", fontSize: 14 } }, "See How It Works \u2192"), /* @__PURE__ */ React.createElement("a", { href: "/pricing", style: { background: "#1a2d5a", color: "#7ec11f", border: "2px solid #7ec11f", borderRadius: 8, padding: "11px 22px", textDecoration: "none", fontWeight: "bold", fontSize: 14 } }, "Get Full Guidance \u2192"))))), screen === "taxpro" && /* @__PURE__ */ React.createElement("div", { style: { maxWidth: 720, margin: "0 auto", padding: "0 16px" } },
    /* @__PURE__ */ React.createElement("button", { onClick: () => setScreen("home"), style: { background: "none", border: "none", color: "#888", cursor: "pointer", marginBottom: 16, fontSize: 14 } }, "\u2190 Back to home"),
    /* @__PURE__ */ React.createElement("h2", { style: { fontSize: 22, fontWeight: "bold", marginBottom: 6, color: "#1a2d5a" } }, "\uD83C\uDFE6 Tax Professionals"),
    /* @__PURE__ */ React.createElement("p", { style: { color: "#666", marginBottom: 24, fontSize: 15 } }, "Two ways to partner with IRS Pilot — earn referral commissions or offer our tools under your own brand."),
    /* @__PURE__ */ React.createElement("div", { style: { display: "grid", gap: 16, marginBottom: 16 } },
      /* @__PURE__ */ React.createElement("div", { style: { background: "#fff", border: "2px solid #7ec11f", borderRadius: 14, padding: "22px 24px" } },
        /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 12, marginBottom: 14 } },
          /* @__PURE__ */ React.createElement("div", { style: { width: 44, height: 44, background: "#f0fdf4", border: "1.5px solid #7ec11f", borderRadius: 10, display: "flex", alignItems: "center", justifyContent: "center", fontSize: 22 } }, "\uD83D\uDCB0"),
          /* @__PURE__ */ React.createElement("div", null,
            /* @__PURE__ */ React.createElement("div", { style: { fontWeight: "bold", fontSize: 17, color: "#1a2d5a" } }, "Referral Program"),
            /* @__PURE__ */ React.createElement("div", { style: { color: "#7ec11f", fontSize: 12, fontWeight: "bold" } }, "Free to join \u2014 earn 20% per sale")
          )
        ),
        /* @__PURE__ */ React.createElement("p", { style: { color: "#555", fontSize: 14, lineHeight: 1.7, marginBottom: 14 } }, "Get a unique referral link and earn 20% commission every time someone purchases through it. No license required. No monthly fee. Works for EAs, CPAs, preparers, attorneys, bookkeepers, and anyone else who works with taxpayers."),
        /* @__PURE__ */ React.createElement("div", { style: { background: "#f8f6f1", borderRadius: 8, padding: "12px 16px", marginBottom: 16 } },
          /* @__PURE__ */ React.createElement("div", { style: { fontSize: 12, fontWeight: "bold", color: "#1a2d5a", marginBottom: 8 } }, "YOUR COMMISSIONS"),
          [["Navigator ($59)", "$11.80"], ["Wizard ($99)", "$19.80"], ["Bundle ($129)", "$25.80"], ["Tax Planning ($99)", "$19.80"]].map(function(r, i) {
            return /* @__PURE__ */ React.createElement("div", { key: i, style: { display: "flex", justifyContent: "space-between", padding: "5px 0", borderBottom: i < 3 ? "1px solid #e8e4dc" : "none", fontSize: 13 } },
              /* @__PURE__ */ React.createElement("span", { style: { color: "#555" } }, r[0]),
              /* @__PURE__ */ React.createElement("span", { style: { color: "#7ec11f", fontWeight: "bold" } }, r[1])
            );
          })
        ),
        /* @__PURE__ */ React.createElement("a", { href: "/referral", style: { display: "inline-block", background: "#1a2d5a", color: "#7ec11f", border: "2px solid #7ec11f", borderRadius: 8, padding: "10px 22px", fontFamily: "'DM Sans',sans-serif", fontWeight: "bold", fontSize: 14, textDecoration: "none" } }, "Join the Referral Program \u2192")
      ),
      /* @__PURE__ */ React.createElement("div", { style: { background: "#fff", border: "2px solid #1a2d5a", borderRadius: 14, padding: "22px 24px" } },
        /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 12, marginBottom: 14 } },
          /* @__PURE__ */ React.createElement("div", { style: { width: 44, height: 44, background: "#eff6ff", border: "1.5px solid #1a2d5a", borderRadius: 10, display: "flex", alignItems: "center", justifyContent: "center", fontSize: 22 } }, "\uD83C\uDFE2"),
          /* @__PURE__ */ React.createElement("div", null,
            /* @__PURE__ */ React.createElement("div", { style: { fontWeight: "bold", fontSize: 17, color: "#1a2d5a" } }, "Pro Subscription"),
            /* @__PURE__ */ React.createElement("div", { style: { color: "#1a2d5a", fontSize: 12, fontWeight: "bold" } }, "$49/mo intro \u2014 white-label for your clients")
          )
        ),
        /* @__PURE__ */ React.createElement("p", { style: { color: "#555", fontSize: 14, lineHeight: 1.7, marginBottom: 14 } }, "Offer IRS Pilot to your clients under your own firm's name. They see your logo, your phone number, and your meeting scheduling link \u2014 not IRS Pilot's. Includes 10 client sessions per month, reseller pricing, and full access to all tools including the Transcript Analyzer."),
        /* @__PURE__ */ React.createElement("div", { style: { background: "#f8f6f1", borderRadius: 8, padding: "12px 16px", marginBottom: 16 } },
          /* @__PURE__ */ React.createElement("div", { style: { fontSize: 12, fontWeight: "bold", color: "#1a2d5a", marginBottom: 8 } }, "WHAT'S INCLUDED"),
          [
            "White-label branding \u2014 your firm name on every screen",
            "10 client sessions per month (+ $5 each additional)",
            "24-hour client access links \u2014 no client login required",
            "Full Navigator, Wizard, Transcript Analyzer access",
            "Reseller pricing \u2014 charge your own rates",
            "$49/month intro rate (first 3 months), then $79/month"
          ].map(function(item, i) {
            return /* @__PURE__ */ React.createElement("div", { key: i, style: { display: "flex", gap: 8, padding: "4px 0", fontSize: 13, color: "#555" } },
              /* @__PURE__ */ React.createElement("span", { style: { color: "#7ec11f", flexShrink: 0 } }, "\u2713"),
              /* @__PURE__ */ React.createElement("span", null, item)
            );
          })
        ),
        /* @__PURE__ */ React.createElement("a", { href: "/taxpro", style: { display: "inline-block", background: "#1a2d5a", color: "#7ec11f", border: "2px solid #7ec11f", borderRadius: 8, padding: "10px 22px", fontFamily: "'DM Sans',sans-serif", fontWeight: "bold", fontSize: 14, textDecoration: "none" } }, "Learn More & Subscribe \u2192")
      ),
      /* @__PURE__ */ React.createElement("div", { style: { background: "#fff", border: "1.5px solid #7ec11f", borderRadius: 12, padding: "22px 24px", marginBottom: 16 } },
        /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "flex-start", gap: 14, marginBottom: 14 } },
          /* @__PURE__ */ React.createElement("div", { style: { fontSize: 28, flexShrink: 0 } }, "\uD83D\uDEE1\uFE0F"),
          /* @__PURE__ */ React.createElement("div", null,
            /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 8, marginBottom: 4 } },
              /* @__PURE__ */ React.createElement("div", { style: { fontWeight: "bold", fontSize: 17, color: "#1a2d5a" } }, "COVID Penalty Relief \u2014 Tax Pro Version"),
              /* @__PURE__ */ React.createElement("span", { style: { background: "#7ec11f", color: "#1a2d5a", fontSize: 9, fontWeight: "bold", padding: "2px 8px", borderRadius: 10, letterSpacing: 0.5 } }, "NEW")
            ),
            /* @__PURE__ */ React.createElement("div", { style: { fontSize: 13, color: "#888", marginBottom: 10, lineHeight: 1.6 } }, "Analyze multiple client transcripts at once for IRC \u00a76751(b) and Notice 2022-36 penalty relief. Generate individual abatement letters (taxpayer or POA) and a combined client summary report. Admin access required."),
            /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 16, flexWrap: "wrap", marginBottom: 14 } },
              [["\uD83D\uDCC2","Batch Mode","Multiple clients at once"],["\u270F\uFE0F","POA Letters","Sign as representative"],["\uD83D\uDCCA","Combined Report","Summary across all clients"]].map(function(item, i) {
                return /* @__PURE__ */ React.createElement("div", { key: i, style: { display: "flex", alignItems: "center", gap: 6 } },
                  /* @__PURE__ */ React.createElement("span", null, item[0]),
                  /* @__PURE__ */ React.createElement("div", null,
                    /* @__PURE__ */ React.createElement("div", { style: { fontSize: 12, fontWeight: "bold", color: "#1a2d5a" } }, item[1]),
                    /* @__PURE__ */ React.createElement("div", { style: { fontSize: 11, color: "#888" } }, item[2])
                  )
                );
              })
            ),
            /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 10, flexWrap: "wrap" } },
              /* @__PURE__ */ React.createElement("a", { href: "/covid-penalty-pro", style: { display: "inline-block", background: "#1a2d5a", color: "#7ec11f", border: "2px solid #7ec11f", borderRadius: 8, padding: "10px 22px", fontFamily: "'DM Sans',sans-serif", fontWeight: "bold", fontSize: 14, textDecoration: "none" } }, "Open Tax Pro Tool \u2192"),
              /* @__PURE__ */ React.createElement("a", { href: "/demo-covid", style: { display: "inline-block", background: "transparent", color: "#1a2d5a", border: "1px solid #e8e4dc", borderRadius: 8, padding: "10px 22px", fontFamily: "'DM Sans',sans-serif", fontSize: 14, textDecoration: "none" } }, "View Demo")
            )
          )
        )
      ),
  ...
  user !== null && user.isPartner === true && user.partnerProfileComplete === false && !profileDismissed &&
    /* @__PURE__ */ React.createElement(PartnerProfilePrompt, { user: user, onDismiss: function(){ setProfileDismissed(true); } }),
  /* @__PURE__ */ React.createElement(SeeItInAction, null),
/* @__PURE__ */ React.createElement(UsageCounter, null),
/* @__PURE__ */ React.createElement("div", { style: { textAlign: "center", padding: "24px 16px", color: "#aaa", fontSize: 12, borderTop: "1px solid #e8e4dc", marginTop: 24 } }, "This tool provides general information only and does not constitute legal or tax advice. For complex situations, consult an Enrolled Agent, CPA, or tax attorney."));
}
