  ...
  /* @__PURE__ */ React.createElement("div", {
    ...
    /* @__PURE__ */ React.createElement("div", { style: { display: "grid", gap: 16, marginBottom: 16 } },
      ...
      /* @__PURE__ */ React.createElement("div", { style: { background: "#fff", border: "2px solid #1a2d5a", borderRadius: 14, padding: "22px 24px" } },
        ...
        /* @__PURE__ */ React.createElement("p", { style: { color: "#555", fontSize: 14, lineHeight: 1.7, marginBottom: 14 } }, "Offer IRS Pilot to your clients under your own firm's name. They see your logo, your phone number, and your Calendly link \u2014 not IRS Pilot's. Includes 10 client sessions per month, reseller pricing, and full access to all tools including the Transcript Analyzer."),
        /* @__PURE__ */ React.createElement("div", { style: { background: "#f8f6f1", borderRadius: 8, padding: "12px 16px", marginBottom: 16 } },
