...
function IRSApp() {
  ...
  return /* @__PURE__ */ React.createElement("div", { style: { fontFamily: "'Georgia', serif", minHeight: "100vh", background: "#f8f6f1", color: "#1a2d5a" } }, /* @__PURE__ */ React.createElement("div", { style: { background: "#1a2d5a", padding: "16px 24px", display: "flex", alignItems: "center", justifyContent: "space-between" } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 12, cursor: "pointer" }, onClick: () => {
    setScreen("home");
    setSelectedNotice(null);
    setSelectedSituation(null);
  } }, /* @__PURE__ */ React.createElement("img", { src: "/static/logo.png", alt: "IRS Pilot", style: { width: 44, height: 44, objectFit: "contain" } }), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { style: { color: "#fff", fontWeight: "bold", fontSize: 16, letterSpacing: 0.5 } }, "IRS Pilot"), /* @__PURE__ */ React.createElement("div", { style: { color: "#7ec11f", fontSize: 11, letterSpacing: 1 } }, "TAXPAYER SELF-HELP"))), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 10, alignItems: "center" } }, /* @__PURE__ */ React.createElement("a", { href: "/tax-professionals", style: { color: "#7ec11f", fontSize: 13, textDecoration: "none", border: "1px solid #7ec11f", padding: "6px 14px", borderRadius: 6 } }, "\u{1F454} Tax Professionals"), /* @__PURE__ */ React.createElement("a", { href: "/pricing", style: { color: "#aaa", fontSize: 13, textDecoration: "none", border: "1px solid #555", padding: "6px 14px", borderRadius: 6 } }, "\u{1F4B3} Pricing"), /* @__PURE__ */ React.createElement("a", { href: "/letters", style: { color: "#7ec11f", fontSize: 13, textDecoration: "none", border: "1px solid #7ec11f", padding: "6px 14px", borderRadius: 6 } }, "\u2709\uFE0F Letters"), /* @__PURE__ */ React.createElement("a", { href: "/account", style: { color: "#aaa", fontSize: 13, textDecoration: "none", border: "1px solid #444", padding: "6px 14px", borderRadius: 6 } }, "My Account"), screen !== "home" && /* @__PURE__ */ React.createElement(
    "button",
    {
      onClick: () => {
        setScreen("home");
      ...
      style: { background: "transparent", border: "1px solid #555", color: "#aaa", padding: "6px 14px", borderRadius: 6, cursor: "pointer", fontSize: 13 }
    },
    "\u2190 Home"
