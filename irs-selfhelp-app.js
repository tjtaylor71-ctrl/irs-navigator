...
function IRSApp() {
  ...
  /* @__PURE__ */ React.createElement("div", { style: { background: "#1a2d5a", borderTop: "3px solid #7ec11f", marginTop: 40, padding: "32px 16px 24px", fontFamily: "'DM Sans',sans-serif" } },
    /* @__PURE__ */ React.createElement("div", { style: { maxWidth: 1200, margin: "0 auto", textAlign: "center" } },
      /* @__PURE__ */ React.createElement("div", { style: { display: "flex", justifyContent: "center", alignItems: "center", flexWrap: "wrap", gap: 24, marginBottom: 18 } },
        /* @__PURE__ */ React.createElement("a", { href: "/terms", style: { color: "#cce8a0", fontSize: 13, textDecoration: "none" } }, "Terms of Service"),
        /* @__PURE__ */ React.createElement("span", { style: { color: "#7ec11f", fontSize: 10 } }, "\u25CF"),
        /* @__PURE__ */ React.createElement("a", { href: "/privacy", style: { color: "#cce8a0", fontSize: 13, textDecoration: "none" } }, "Privacy Policy"),
        /* @__PURE__ */ React.createElement("span", { style: { color: "#7ec11f", fontSize: 10 } }, "\u25CF"),
        /* @__PURE__ */ React.createElement("a", { href: "/security", style: { color: "#cce8a0", fontSize: 13, textDecoration: "none" } }, "Security & Privacy"),
        /* @__PURE__ */ React.createElement("span", { style: { color: "#7ec11f", fontSize: 10 } }, "\u25CF"),
        /* @__PURE__ */ React.createElement("a", { href: "mailto:info@irspilot.com", style: { color: "#cce8a0", fontSize: 13, textDecoration: "none" } }, "Contact")
      ),
      /* @__PURE__ */ React.createElement("div", { style: { color: "#8a9ab8", fontSize: 11, lineHeight: 1.6, maxWidth: 720, margin: "0 auto 14px" } }, "This tool provides general information only and does not constitute legal or tax advice. For complex situations, consult an Enrolled Agent, CPA, or tax attorney."),
      /* @__PURE__ */ React.createElement("div", { style: { color: "#6a7a98", fontSize: 11 } }, "\u00A9 ", new Date().getFullYear(), " IRS Pilot LLC \u2014 All rights reserved")
    )
  ));
}
