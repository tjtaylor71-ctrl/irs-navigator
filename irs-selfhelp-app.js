...
function IRSApp() {
  ...
  return /* @__PURE__ */ React.createElement("div", { style: { fontFamily: "'Georgia', serif", minHeight: "100vh", background: "#f8f6f1", color: "#1a1a2e" } }, /* @__PURE__ */ React.createElement("div", { style: { background: "#1a1a2e", padding: "16px 24px", display: "flex", alignItems: "center", justifyContent: "space-between" } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 12, cursor: "pointer" }, onClick: () => {
    setScreen("home");
    setSelectedNotice(null);
    setSelectedSituation(null);
  } }, /* @__PURE__ */ React.createElement("div", { style: { width: 36, height: 36, background: "#c8a96e", borderRadius: 8, display: "flex", alignItems: "center", justifyContent: "center", fontSize: 18 } }, "\u2696\uFE0F"), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { style: { color: "#fff", fontWeight: "bold", fontSize: 16, letterSpacing: 0.5 } }, "IRS Navigator"), /* @__PURE__ */ React.createElement("div", { style: { color: "#c8a96e", fontSize: 11, letterSpacing: 1 } }, "TAXPAYER SELF-HELP"))), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 10, alignItems: "center" } }, /* @__PURE__ */ React.createElement("a", { href: "/pricing", style: { color: "#c8a96e", fontSize: 13, textDecoration: "none", border: "1px solid #c8a96e", padding: "6px 14px", borderRadius: 6 } }, "\u{1F4B3} Pricing"), /* @__PURE__ */ React.createElement("a", { href: "/letters", style: { color: "#c8a96e", fontSize: 13, textDecoration: "none", border: "1px solid #c8a96e", padding: "6px 14px", borderRadius: 6 } }, "\u2709\uFE0F Letters"), /* @__PURE__ */ React.createElement("a", { href: "/account", style: { color: "#aaa", fontSize: 13, textDecoration: "none", border: "1px solid #444", padding: "6px 14px", borderRadius: 6 } }, "My Account"), screen !== "home" && /* @__PURE__ */ React.createElement(
    "button",
    {
      onClick: () => {
        setScreen("home");
    ...
    "\u2190 Home"
  ))), /* @__PURE__ */ React.createElement("div", { style: { maxWidth: 720, margin: "0 auto", padding: "24px 16px" } }, screen === "home" && /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { style: { textAlign: "center", padding: "32px 0 24px" } }, /* @__PURE__ */ React.createElement("div", { style: { display: "inline-block", background: "#dc2626", color: "#fff", fontSize: 11, fontWeight: "bold", letterSpacing: 1.5, padding: "4px 12px", borderRadius: 20, marginBottom: 14 } }, "\u26A0 TIME-SENSITIVE \u2014 IRS DEADLINES DO NOT WAIT"), /* @__PURE__ */ React.createElement("h1", { style: { fontSize: 28, fontWeight: "bold", margin: "0 0 10px", color: "#1a1a2e" } }, "Don't Face the IRS Alone"), /* @__PURE__ */ React.createElement("p", { style: { fontSize: 16, color: "#555", margin: "0 0 6px" } }, "Every day you wait, penalties and interest grow. This tool gives you the plain-English guidance you need to take action right now.")), /* @__PURE__ */ React.createElement("div", { style: { background: "#1a1a2e", borderRadius: 12, padding: 20, marginBottom: 20, display: "flex", gap: 16, alignItems: "flex-start" } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 32, flexShrink: 0 } }, "\u{1F3DB}\uFE0F"), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { style: { color: "#c8a96e", fontWeight: "bold", fontSize: 14, marginBottom: 6 } }, "BUILT BY AN ENROLLED AGENT"), /* @__PURE__ */ React.createElement("div", { style: { color: "#e8e4dc", fontSize: 14, lineHeight: 1.7 } }, "This tool was created by ", /* @__PURE__ */ React.createElement("strong", { style: { color: "#c8a96e" } }, "Tyrone J. Taylor, EA"), " \u2014 an IRS Enrolled Agent and author of ", /* @__PURE__ */ React.createElement("em", null, "Stop IRS Collections"), ". Enrolled Agents are federally licensed tax professionals with the highest credential the IRS grants to private practitioners. Every piece of guidance in this tool reflects real IRS resolution practice."))), /* @__PURE__ */ React.createElement("div", { style: { background: "#fff", border: "1px solid #e8e4dc", borderRadius: 12, padding: 20, marginBottom: 20 } }, /* @__PURE__ */ React.createElement("div", { style: { fontWeight: "bold", fontSize: 16, color: "#1a1a2e", marginBottom: 14 } }, "\u26A1 How This Tool Works \u2014 3 Steps"), /* @__PURE__ */ React.createElement("div", { style: { display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 14 } }, [
  ...
  ].map((s) => /* @__PURE__ */ React.createElement("div", { key: s.n, style: { textAlign: "center", padding: "14px 10px", background: "#f8f6f1", borderRadius: 8 } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 24, marginBottom: 6 } }, s.icon), /* @__PURE__ */ React.createElement("div", { style: { fontWeight: "bold", fontSize: 13, color: "#1a1a2e", marginBottom: 4 } }, s.title), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 12, color: "#666", lineHeight: 1.5 } }, s.desc))))), /* @__PURE__ */ React.createElement("div", { style: { background: "#fff", border: "1px solid #e8e4dc", borderRadius: 12, padding: 20, marginBottom: 20 } }, /* @__PURE__ */ React.createElement("div", { style: { fontWeight: "bold", fontSize: 16, color: "#1a1a2e", marginBottom: 14 } }, "\u{1F9ED} Where Do I Start?"), /* @__PURE__ */ React.createElement("div", { style: { display: "grid", gap: 10 } }, [
  ...
  ].map((item, i) => /* @__PURE__ */ React.createElement("div", { key: i, style: { display: "flex", gap: 12, padding: "12px 14px", background: "#f8f6f1", borderRadius: 8, alignItems: "flex-start" } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 20, flexShrink: 0 } }, item.icon), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { style: { fontWeight: "bold", fontSize: 13, color: "#1a1a2e", marginBottom: 3 } }, item.q), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 13, color: "#555", lineHeight: 1.5 } }, item.a)))))), /* @__PURE__ */ React.createElement("div", { style: { display: "grid", gap: 16, gridTemplateColumns: "1fr 1fr", marginBottom: 20 } }, /* @__PURE__ */ React.createElement(
    "div",
    {
  ...
  )), /* @__PURE__ */ React.createElement("div", { style: { background: "#fff", border: "2px solid #c8a96e", borderRadius: 12, padding: 20, marginBottom: 20, display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: 16 } }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { style: { fontWeight: "bold", fontSize: 15, color: "#1a1a2e", marginBottom: 4 } }, "\u{1F4CB} Ready to complete your IRS financial forms?"), /* @__PURE__ */ React.createElement("div", { style: { color: "#666", fontSize: 13 } }, "The intake wizard calculates your resolution options and auto-fills Forms 433-F, 433-A, 433-A OIC, and Form 656.")), /* @__PURE__ */ React.createElement(
    "a",
    {
      href: "/wizard",
      target: "_blank",
      rel: "noopener noreferrer",
      style: { display: "inline-flex", alignItems: "center", gap: 8, padding: "10px 18px", background: "#1a1a2e", color: "#c8a96e", border: "2px solid #c8a96e", borderRadius: 8, fontFamily: "Georgia, serif", fontWeight: "bold", fontSize: 14, textDecoration: "none" }
    },
    "Complete Your IRS Financial Forms \u2192"
  )), /* @__PURE__ */ React.createElement("div", { style: { background: "#eff6ff", border: "1px solid #bfdbfe", borderRadius: 12, padding: 20, marginBottom: 20 } }, /* @__PURE__ */ React.createElement("div", { style: { fontWeight: "bold", fontSize: 16, color: "#1e40af", marginBottom: 6 } }, "\u{1F5A5}\uFE0F Pull Up Your IRS Online Account First"), /* @__PURE__ */ React.createElement("p", { style: { fontSize: 14, color: "#1e3a8a", lineHeight: 1.7, margin: "0 0 12px" } }, "Most taxpayers don't know this exists. Your IRS Online Account is a free, secure portal that shows you everything the IRS has on file \u2014 before you call, before you file anything, before you make any decisions."), /* @__PURE__ */ React.createElement("div", { style: { display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8, marginBottom: 14 } }, [
  ...
  ].map((item, i) => /* @__PURE__ */ React.createElement("div", { key: i, style: { display: "flex", gap: 8, fontSize: 13, color: "#1e3a8a", alignItems: "flex-start" } }, /* @__PURE__ */ React.createElement("span", { style: { color: "#2563eb", fontWeight: "bold", flexShrink: 0 } }, "\u2713"), " ", item))), /* @__PURE__ */ React.createElement(
    "a",
    {
    ...
    "button",
    {
      ...
      style: { background: "#1a1a2e", color: "#c8a96e", border: "none", borderRadius: 8, padding: "10px 20px", cursor: "pointer", fontWeight: "bold", fontSize: 14 }
    },
    "Look Up \u2192"
  )), noticeError && /* @__PURE__ */ React.createElement("div", { style: { color: "#dc2626", marginTop: 10, fontSize: 14 } }, noticeError)), /* @__PURE__ */ React.createElement("div", { style: { marginBottom: 8 } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 10, marginBottom: 12 } }, /* @__PURE__ */ React.createElement("span", { style: { fontWeight: "bold", color: "#1a1a2e", fontSize: 14, letterSpacing: 0.5 } }, "\u{1F4CB} COLLECTION NOTICES"), /* @__PURE__ */ React.createElement("span", { style: { fontSize: 12, color: "#888" } }, "\u2014 In escalation order")), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", marginBottom: 16, padding: "0 4px" } }, collectionSequence.map((key, i) => {
