...
function IRSApp() {
  ...
  })), /* @__PURE__ */ React.createElement("div", { style: { background: "#f8f6f1", borderRadius: 8, padding: "8px 12px", fontSize: 13, color: "#888" } }, "\u{1F4C4} ", opt.form), needsWizard(opt.title, opt.desc, opt.form) && /* @__PURE__ */ React.createElement(WizardButton, null)))))), /* @__PURE__ */ React.createElement("div", { style: { textAlign: "center", padding: "24px 16px", color: "#aaa", fontSize: 12, borderTop: "1px solid #e8e4dc", marginTop: 24 } }, "This tool provides general information only and does not constitute legal or tax advice. For complex situations, consult an Enrolled Agent, CPA, or tax attorney."));
}
