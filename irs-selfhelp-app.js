...
function IRSApp() {
  ...
  /* @__PURE__ */ React.createElement("div", { style: { display: "grid", gap: 12, gridTemplateColumns: "1fr 1fr", marginBottom: 12 } },
    /* @__PURE__ */ React.createElement(
      "div",
      {
        onClick: () => setScreen("taxpro"),
        style: { background: "#fff", border: "2px solid #e8e4dc", borderRadius: 14, padding: "20px 18px", cursor: "pointer", transition: "all 0.2s" },
      ...
      /* @__PURE__ */ React.createElement("div", { style: { width: 44, height: 44, background: "#f0fdf4", border: "1.5px solid #7ec11f", borderRadius: 10, display: "flex", alignItems: "center", justifyContent: "center", fontSize: 20, marginBottom: 12 } }, "\uD83C\uDFE6"),
      /* @__PURE__ */ React.createElement("div", { style: { fontWeight: "bold", fontSize: 16, marginBottom: 6, color: "#1a2d5a" } }, "Tax Professionals"),
      /* @__PURE__ */ React.createElement("div", { style: { color: "#666", fontSize: 13, lineHeight: 1.6, marginBottom: 12 } }, "Refer clients or offer IRS Pilot under your own brand. Earn commissions or subscribe as a pro."),
    ...
    /* @__PURE__ */ React.createElement(
      ...
      /* @__PURE__ */ React.createElement("div", { style: { width: 44, height: 44, background: "#fef3c7", border: "1.5px solid #f59e0b", borderRadius: 10, display: "flex", alignItems: "center", justifyContent: "center", fontSize: 20, marginBottom: 12 } }, "\uD83D\uDCB3"),
      /* @__PURE__ */ React.createElement("div", { style: { fontWeight: "bold", fontSize: 16, marginBottom: 6, color: "#1a2d5a" } }, "Pricing & Access"),
      /* @__PURE__ */ React.createElement("div", { style: { color: "#666", fontSize: 13, lineHeight: 1.6, marginBottom: 12 } }, "Navigator, Wizard, Bundle, and Tax Planning. Starts at $59."),
