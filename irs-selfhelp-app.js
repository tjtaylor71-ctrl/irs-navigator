...
function IRSApp() {
  ...
  })), /* @__PURE__ */ React.createElement("div", { style: { background: "#f8f6f1", borderRadius: 8, padding: "8px 12px", fontSize: 13, color: "#888" } }, "\uD83D\uDCC4 ", opt.form), needsWizard(opt.title, opt.desc, opt.form) && /* @__PURE__ */ React.createElement(WizardButton, null)))))), screen === "taxpro" && /* @__PURE__ */ React.createElement("div", null,
