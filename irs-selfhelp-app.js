...
function IRSApp() {
  ...
  return /* @__PURE__ */ React.createElement("div", { style: { fontFamily: "'Georgia', serif", minHeight: "100vh", background: "#f8f6f1", color: "#1a2d5a" } }, /* @__PURE__ */ React.createElement("div", { style: { background: "#1a2d5a", padding: "14px 24px", borderBottom: "3px solid #7ec11f", display: "flex", alignItems: "center", justifyContent: "space-between" } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 12, cursor: "pointer" }, onClick: () => {
    setScreen("home");
    setSelectedNotice(null);
    setSelectedSituation(null);
  } }, /* @__PURE__ */ React.createElement("img", { src: "/static/logo.png", alt: "IRS Pilot", style: { width: 40, height: 40, objectFit: "contain" } }), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { style: { color: "#fff", fontWeight: "bold", fontSize: 16, letterSpacing: 0.3 } }, "IRS Pilot"), /* @__PURE__ */ React.createElement("div", { style: { color: "#7ec11f", fontSize: 10, letterSpacing: 1 } }, "TAXPAYER SELF-HELP"))), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 8 } }, screen !== "home" && /* @__PURE__ */ React.createElement(
    "button",
    {
      onClick: () => {
        setScreen("home");
      ...
      style: { background: "transparent", border: "1px solid #7ec11f", color: "#7ec11f", padding: "6px 12px", borderRadius: 6, cursor: "pointer", fontSize: 12, fontFamily: "Georgia, serif" }
    },
    "\u2190 Home"
    ...
    {
      href: "/pricing",
      style: { color: "#cce8a0", fontSize: 12, textDecoration: "none", padding: "6px 12px", borderRadius: 6, border: "1px solid rgba(255,255,255,0.2)", fontFamily: "Georgia, serif" },
    ...
    {
      href: "/login",
      style: { background: "#7ec11f", color: "#1a2d5a", fontSize: 12, textDecoration: "none", padding: "6px 14px", borderRadius: 6, fontWeight: "bold", fontFamily: "Georgia, serif" },
      onMouseEnter: (e) => e.currentTarget.style.background = "#6aad18",
      onMouseLeave: (e) => e.currentTarget.style.background = "#7ec11f"
    },
    "Sign In"
    ...
    /* @__PURE__ */ React.createElement("div", { style: { width: 44, height: 44, background: "#f0fdf4", border: "1.5px solid #7ec11f", borderRadius: 10, display: "flex", alignItems: "center", justifyContent: "center", fontSize: 20, marginBottom: 12 } }, "\u{1F4EC}"),
    ...
    { icon: "\u{1F4B8}", label: "I owe taxes but can't pay", sub: "Payment plans \xB7 OIC \xB7 Hardship status", id: "cant-pay", urgency: null },
    { icon: "\u{1F6A8}", label: "My bank account or wages are being levied", sub: "21-day window \xB7 CDP hearing rights \xB7 Release options", id: "levy", urgency: "urgent" },
    { icon: "\u{1F4CB}", label: "I haven't filed tax returns", sub: "Back filing \xB7 IRS policy \xB7 Penalties", id: "unfiled", urgency: null },
