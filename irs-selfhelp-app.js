...
function IRSApp() {
  ...
  return /* @__PURE__ */ React.createElement("div", { style: { fontFamily: "'Georgia', serif", minHeight: "100vh", background: "#f8f6f1", color: "#1a1a2e" } }, /* @__PURE__ */ React.createElement("div", { style: { background: "#1a1a2e", padding: "16px 24px", display: "flex", alignItems: "center", justifyContent: "space-between" } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 12, cursor: "pointer" }, onClick: () => {
    ...
    "\u2190 Home"
  )), /* @__PURE__ */ React.createElement("div", { style: { maxWidth: 720, margin: "0 auto", padding: "24px 16px" } }, screen === "home" && /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { style: { textAlign: "center", padding: "32px 0 28px" } }, /* @__PURE__ */ React.createElement("h1", { style: { fontSize: 28, fontWeight: "bold", margin: "0 0 10px", color: "#1a1a2e" } }, "Don't Face the IRS Alone"), /* @__PURE__ */ React.createElement("p", { style: { fontSize: 16, color: "#555", margin: 0 } }, "Plain-English guidance for real IRS situations \u2014 no tax jargon, no guesswork.")), /* @__PURE__ */ React.createElement("div", { style: { display: "grid", gap: 16, gridTemplateColumns: "1fr 1fr" } }, /* @__PURE__ */ React.createElement(
    "div",
    {
  ...
  )), /* @__PURE__ */ React.createElement("div", { style: { background: "#1a1a2e", borderRadius: 12, padding: 20, marginTop: 20, display: "flex", gap: 16, alignItems: "center" } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 28 } }, "\u{1F4A1}"), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { style: { color: "#c8a96e", fontWeight: "bold", fontSize: 14, marginBottom: 4 } }, "PRO TIP"), /* @__PURE__ */ React.createElement("div", { style: { color: "#e8e4dc", fontSize: 14, lineHeight: 1.6 } }, 'The IRS wants to resolve issues \u2014 not chase you. Responding to any notice, even just to say "I need more time," is always better than silence.')))), screen === "notice-lookup" && /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("h2", { style: { fontSize: 22, fontWeight: "bold", marginBottom: 6 } }, "\u{1F4EC} Look Up Your IRS Notice"), /* @__PURE__ */ React.createElement("p", { style: { color: "#666", marginBottom: 24, fontSize: 15 } }, 'Your notice number is in the upper right corner of the letter \u2014 it looks like "CP2000" or "LT11".'), /* @__PURE__ */ React.createElement("div", { style: { background: "#fff", borderRadius: 12, padding: 24, border: "1px solid #e8e4dc", marginBottom: 24 } }, /* @__PURE__ */ React.createElement("label", { style: { fontWeight: "bold", display: "block", marginBottom: 8 } }, "Enter Notice Number"), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 10 } }, /* @__PURE__ */ React.createElement(
    "input",
    {
      value: noticeInput,
  ...
  })), /* @__PURE__ */ React.createElement("div", { style: { background: "#f8f6f1", borderRadius: 8, padding: "8px 12px", fontSize: 13, color: "#888" } }, "\u{1F4C4} ", opt.form)))))), /* @__PURE__ */ React.createElement("div", { style: { textAlign: "center", padding: "24px 16px", color: "#aaa", fontSize: 12, borderTop: "1px solid #e8e4dc", marginTop: 24 } }, "This tool provides general information only and does not constitute legal or tax advice. For complex situations, consult an Enrolled Agent, CPA, or tax attorney."));
}
