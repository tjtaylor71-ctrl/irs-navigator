...
function IRSApp() {
  ...
  return /* @__PURE__ */ React.createElement("div", { style: { fontFamily: "'Georgia', serif", minHeight: "100vh", background: "#f8f6f1", color: "#1a1a2e" } }, /* @__PURE__ */ React.createElement("div", { style: { background: "#1a1a2e", padding: "16px 24px", display: "flex", alignItems: "center", justifyContent: "space-between" } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 12, cursor: "pointer" }, onClick: () => {
  ...
  ].map((item, i) => /* @__PURE__ */ React.createElement("div", { key: i, style: { display: "flex", gap: 10, fontSize: 13, color: "#7f1d1d", alignItems: "flex-start" } }, /* @__PURE__ */ React.createElement("span", { style: { color: "#dc2626", fontWeight: "bold", flexShrink: 0 } }, "\u2717"), " ", item))), /* @__PURE__ */ React.createElement("div", { style: { borderTop: "1px solid #fecaca", paddingTop: 14 } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 13, color: "#7f1d1d", marginBottom: 12 } }, "If any of these apply, a free consultation with an Enrolled Agent can help you understand your options before the situation gets worse."), /* @__PURE__ */ React.createElement(
    "a",
    {
    ...
    "\u{1F4C5} Schedule a Free Consultation \u2192"
