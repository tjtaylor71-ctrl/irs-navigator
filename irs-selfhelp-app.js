...
function IRSApp() {
  ...
  const brandName = proContext ? proContext.firmName : { brandName };
  const brandContact = proContext ? proContext.contactName : { brandContact };
  const brandPhone = proContext ? proContext.contactPhone : { brandPhone };
  const brandUrl = proContext ? proContext.calendlyUrl : { brandUrl };
  const allNotices = {
    ...collectionNotices,
    ...auditNotices,
