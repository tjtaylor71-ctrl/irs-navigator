...
function IRSApp() {
  ...
  return /* @__PURE__ */ React.createElement("div", { style: { fontFamily: "'Georgia', serif", minHeight: "100vh", background: "#f8f6f1", color: "#1a2d5a" } }, /* @__PURE__ */ React.createElement("div", { style: { background: "#1a2d5a", padding: "14px 24px", borderBottom: "3px solid #7ec11f", display: "flex", alignItems: "center", justifyContent: "space-between" } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 12, cursor: "pointer" }, onClick: () => {
    ...
    "View All Situations \u2192"
  ))), /* @__PURE__ */ React.createElement("div", { style: { background: "#1a2d5a", borderRadius: 14, padding: "18px 20px", marginBottom: 12, display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: 14 } }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { style: { color: "#7ec11f", fontWeight: "bold", fontSize: 13, marginBottom: 4 } }, "FINANCIAL INTAKE WIZARD"), /* @__PURE__ */ React.createElement("div", { style: { color: "#fff", fontSize: 14, fontWeight: "bold", marginBottom: 4 } }, "Ready to complete your IRS forms?"), /* @__PURE__ */ React.createElement("div", { style: { color: "#94a3b8", fontSize: 12 } }, "Auto-fills Forms 433-F, 433-A, 433-A OIC, and Form 656")), /* @__PURE__ */ React.createElement(WizardButton, null)), /* @__PURE__ */ React.createElement("div", { style: { background: "#fff", border: "1px solid #e8e4dc", borderRadius: 14, padding: "16px 18px", display: "flex", gap: 14, alignItems: "flex-start" } }, /* @__PURE__ */ React.createElement("div", { style: { width: 36, height: 36, background: "#1a2d5a", borderRadius: 8, display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0, fontSize: 16 } }, "\u{1F4A1}"), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { style: { color: "#1a2d5a", fontWeight: "bold", fontSize: 12, letterSpacing: 0.5, marginBottom: 4 } }, "PRO TIP FROM TYRONE J. TAYLOR, EA"), /* @__PURE__ */ React.createElement("div", { style: { color: "#555", fontSize: 13, lineHeight: 1.7 } }, 'The IRS wants to resolve issues \u2014 not chase you. Responding to any notice, even just to say "I need more time," is always better than silence.')))), screen === "notice-lookup" && /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("h2", { style: { fontSize: 22, fontWeight: "bold", marginBottom: 6 } }, "\u{1F4EC} Look Up Your IRS Notice"), /* @__PURE__ */ React.createElement("p", { style: { color: "#666", marginBottom: 24, fontSize: 15 } }, 'Your notice number is in the upper right corner of the letter \u2014 it looks like "CP2000" or "LT11".'), /* @__PURE__ */ React.createElement("div", { style: { background: "#fff", borderRadius: 12, padding: 24, border: "1px solid #e8e4dc", marginBottom: 24 } }, /* @__PURE__ */ React.createElement("label", { style: { fontWeight: "bold", display: "block", marginBottom: 8 } }, "Enter Notice Number"), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 10 } }, /* @__PURE__ */ React.createElement(
    "input",
    {
      value: noticeInput,
